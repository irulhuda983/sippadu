...
class Bengkel extends CI_Controller {
	...
	var $nama_izin 	= 'Izin Usaha Bengkel Kendaraan Bermotor';
	var $class_izin	= 'bengkel';
	var $kode_izin	= 21;
	
	function __construct()
	{
		parent::__construct();
		$this->load->model(array('mod_bengkel','mod_all'));
	...
	public function fo($offset=0)
	{
		...
		$d['PageAkses'] = PageAkses(250,$DataAkses);
		
		if($this->input->post('delete')){
			$this->mod_bengkel->delete_tbl_bengkel();
		}
		...
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_bengkel_fo(0,$limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_bengkel_fo(0)->num_rows();
		$d['Kd_Verifikasi'] = 1;
	...
	public function fo_all($offset=0)
	{
		...
		$d['limit'] = $limit = config('limit');
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_bengkel_fo(1,$limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_bengkel_fo(1)->num_rows();
		$d['Kd_Verifikasi'] = 0;
	...
	public function bo($offset=0)
	{
		$d = $this->mod_all->load();
		$d['DataAkses']	= $DataAkses = DataAkses($this->session->userdata('userid'));
		$d['PageAkses'] = PageAkses(251,$DataAkses);
		...
		$d['limit'] = $limit = config('limit');
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_bengkel_bo(0,$limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_bengkel_bo(0)->num_rows();
		$d['Kd_Verifikasi'] = 1;
	...
	public function bo_all($offset=0)
	{
		...
		$d['limit'] = $limit = config('limit');
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_bengkel_bo(1,$limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_bengkel_bo(1)->num_rows();
		$d['Kd_Verifikasi'] = 0;
	...
	public function kabid($offset=0)
	{
		$d = $this->mod_all->load();
		$d['DataAkses']	= $DataAkses = DataAkses($this->session->userdata('userid'));
		$d['PageAkses'] = PageAkses(252,$DataAkses);
		...
		if($this->input->post('verifikasi')){
			$this->mod_bengkel->verifikasi_tbl_bengkel('kabid',1);
		}
		...
		$d['limit'] = $limit = config('limit');
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_bengkel_kabid(0,$limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_bengkel_kabid(0)->num_rows();
		$d['Kd_Verifikasi'] = 1;
	...
	public function kabid_all($offset=0)
	{
		...
		if($this->input->post('verifikasi')){
			$this->mod_bengkel->verifikasi_tbl_bengkel('kabid',0);
		}
		...
		$d['limit'] = $limit = config('limit');
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_bengkel_kabid(1,$limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_bengkel_kabid(1)->num_rows();
		$d['Kd_Verifikasi'] = 0;
	...
	public function kadin($offset=0)
	{
		$d = $this->mod_all->load();
		$d['DataAkses']	= $DataAkses = DataAkses($this->session->userdata('userid'));
		$d['PageAkses'] = PageAkses(253,$DataAkses);
		...
		if($this->input->post('verifikasi')){
			$this->mod_bengkel->verifikasi_tbl_bengkel('kadin',1);
		}
		...
		$d['limit'] = $limit = config('limit');
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_bengkel_kadin(0,$limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_bengkel_kadin(0)->num_rows();
		$d['Kd_Verifikasi'] = 1;
	...
	public function kadin_all($offset=0)
	{
		...
		if($this->input->post('verifikasi')){
			$this->mod_bengkel->verifikasi_tbl_bengkel('kadin',0);
		}
		...
		$d['limit'] = $limit = config('limit');
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_bengkel_kadin(1,$limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_bengkel_kadin(1)->num_rows();
		$d['Kd_Verifikasi'] = 0;
	...
	public function tu($offset=0)
	{
		$d = $this->mod_all->load();
		$d['DataAkses']	= $DataAkses = DataAkses($this->session->userdata('userid'));
		$d['PageAkses'] = PageAkses(254,$DataAkses);
		...
		if($this->input->post('verifikasi')){
			$this->mod_bengkel->verifikasi_tbl_bengkel('tu',1);
		}
		...
		$d['limit'] = $limit = config('limit');
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_bengkel_tu(0,$limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_bengkel_tu(0)->num_rows();
		$d['Kd_Verifikasi'] = 1;
	...
	public function tu_all($offset=0)
	{
		...
		if($this->input->post('verifikasi')){
			$this->mod_bengkel->verifikasi_tbl_bengkel('tu',0);
		}
		$d['title'] = $title = $this->nama_izin;
		$d['site_title'] = site_title($title);
		$d['menuopen'] = 'tu';
		...
		$d['limit'] = $limit = config('limit');
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_bengkel_tu(1,$limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_bengkel_tu(1)->num_rows();
		$d['Kd_Verifikasi'] = 0;
	...
	public function cetak($offset=0)
	{
		$d = $this->mod_all->load();
		$d['DataAkses']	= $DataAkses = DataAkses($this->session->userdata('userid'));
		$d['PageAkses'] = PageAkses(255,$DataAkses);
		...
		$d['limit'] = $limit = config('limit');
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_bengkel_cetak(0,$limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_bengkel_cetak(0)->num_rows();
		$d['Kd_Verifikasi'] = 1;
	...
	public function cetak_all($offset=0)
	{
		...
		$d['limit'] = $limit = config('limit');
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_bengkel_cetak(1,$limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_bengkel_cetak(1)->num_rows();
		$d['Kd_Verifikasi'] = 0;
	...
	public function serah($offset=0)
	{
		$d = $this->mod_all->load();
		$d['DataAkses']	= $DataAkses = DataAkses($this->session->userdata('userid'));
		$d['PageAkses'] = PageAkses(256,$DataAkses);
		...
		if($this->input->post('verifikasi')){
			$this->mod_bengkel->verifikasi_tbl_bengkel('serah',1);
		}
		...
		$d['limit'] = $limit = config('limit');
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_bengkel_serah(0,$limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_bengkel_serah(0)->num_rows();
		$d['Kd_Verifikasi'] = 1;
	...
	public function serah_all($offset=0)
	{
		...
		if($this->input->post('verifikasi')){
			$this->mod_bengkel->verifikasi_tbl_bengkel('serah',0);
		}
		...
		$d['limit'] = $limit = config('limit');
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_bengkel_serah(1,$limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_bengkel_serah(1)->num_rows();
		$d['Kd_Verifikasi'] = 0;
	...
	public function serah_win($idizin=0)
	{
		...
		if($this->input->post('submit')){
			$this->mod_bengkel->simpan_pengambil($idizin);
		}
		...
		$d['data'] = $this->mod_bengkel->data_serah($idizin);
	...
	{
		$d['data'] = $this->mod_bengkel->data_serah_ajax();
		$d['Class_Izin'] = $this->class_izin;
	...
	public function rekom($offset=0)
	{
		$d = $this->mod_all->load();
		$d['DataAkses']	= $DataAkses = DataAkses($this->session->userdata('userid'));
		$d['PageAkses'] = PageAkses(258,$DataAkses);
		...
		$d['limit'] = $limit = config('limit');
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_bengkel_rekom(0,$limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_bengkel_rekom(0)->num_rows();
		$d['Kd_Verifikasi'] = 1;
	...
	public function rekom_all($offset=0)
	{
		...
		$d['limit'] = $limit = config('limit');
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_bengkel_rekom(1,$limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_bengkel_rekom(1)->num_rows();
		$d['Kd_Verifikasi'] = 0;
	...
	public function fo_data($offset=0)
	{
		...
		$d['limit'] = $limit = config('limit');
		$d['offset'] = $offset;
		$d['data'] = $this->mod_bengkel->get_tbl_personal($limit,$offset);
		$d['tot'] = $tot = $this->mod_bengkel->get_tbl_personal()->num_rows();
	...
	public function fo_daftar($jenis_izin=1,$idpelanggan=0,$idperusahaan=0)
	{
		...
		if($this->input->post('submit')){
			$this->mod_bengkel->insert_bengkel_fo();
		}
		...
		$d['Class_Izin'] = $this->class_izin;
		$d['Kd_Access'] = 'fo';
		$d['Kd_Izin'] = $this->kode_izin; //kode bengkel
		$d['ID_Izin'] = 0;
		$d['op_provinsi'] = $this->mod_bengkel->op_provinsi();
		$d['op_kota'] = $this->mod_bengkel->op_kota();
		$d['op_kecamatan'] = $this->mod_bengkel->op_kecamatan();
		$d['op_desa'] = $this->mod_bengkel->op_desa();
		$d['op_perusahaan'] = $this->mod_bengkel->op_perusahaan($idpelanggan);
		$d['op_bentuk_perusahaan'] = $this->mod_bengkel->op_bentuk_perusahaan();
		$d['data'] = $this->mod_bengkel->get_personal($idpelanggan);
		$d['Kd_Pelanggan'] = $idpelanggan;
		$d['Kd_Perusahaan'] = $idperusahaan;
		$d['Kd_Jenis'] = $jenis_izin;
		$d['op_jenis_izin'] = $this->mod_bengkel->op_jenis_izin();
		$d['op_pengurus_permohonan'] = $this->mod_bengkel->op_pengurus_permohonan();
		$d['op_status_perusahaan'] = $this->mod_bengkel->op_status_perusahaan();
		$d['op_kategori_bengkel'] = $this->mod_bengkel->op_kategori_bengkel();
		$d['op_kegiatan_usaha'] = $this->mod_bengkel->op_kegiatan_usaha();
		$d['op_kelembagaan'] = $this->mod_bengkel->op_kelembagaan();
		$d['op_verifikasi'] = $this->mod_bengkel->op_verifikasi();
		$d['op_serah_terima'] = $this->mod_bengkel->op_serah_terima();
		$d['op_bukti_terima'] = $this->mod_bengkel->op_bukti_terima();
		$d['op_kategori_izin'] = $this->mod_bengkel->op_kategori_izin();
	...
	public function fo_edit($id=0)
	{
		...
		$idperusahaan = 0;
		$Kd_Pengurus = 0;
		$data = $this->mod_bengkel->get_bengkel($id);
		if($data->num_rows() > 0){
			$aa = $data->row();
		...
		if($this->input->post('submit')){
			$this->mod_bengkel->update_bengkel($id);
		}
		...
		$d['op_bentuk_perusahaan'] = $this->mod_bengkel->op_bentuk_perusahaan();
		$d['data'] = $this->mod_bengkel->get_personal($idpelanggan);
		$d['data2'] = $this->mod_bengkel->get_data_bengkel($id);
		$d['Kd_Pelanggan'] = $idpelanggan;
		$d['Kd_Perusahaan'] = $idperusahaan;
		$d['Kd_Jenis'] = $jenis_izin;
		...
		$d['op_bukti_terima'] = $this->mod_bengkel->op_bukti_terima();
		$d['op_kategori_izin'] = $this->mod_bengkel->op_kategori_izin();
		$d['replace'] = $this->mod_bengkel->for_replace($id);
	...
	public function bo_edit($id=0)
	{
		...
		$d = $this->mod_all->load();
		$d['DataAkses']	= $DataAkses = DataAkses($this->session->userdata('userid'));
		$d['PageAkses'] = PageAkses(array(250,251),$DataAkses);
	...
	public function rekom_edit($id=0)
	{
		...
		$d = $this->mod_all->load();
		$d['DataAkses']	= $DataAkses = DataAkses($this->session->userdata('userid'));
		$d['PageAkses'] = PageAkses(array(258),$DataAkses);
	...
	public function fo_proses($id=0,$jenis_izin=0,$idpelanggan=0,$idperusahaan=0)
	{
		...
		if($this->input->post('submit')){
			...
			$this->mod_bengkel->update_bengkel_fo($idperusahaan);
		}
		...
		$d['op_bentuk_perusahaan'] = $this->mod_bengkel->op_bentuk_perusahaan();
		$d['data'] = $this->mod_bengkel->get_personal($idpelanggan);
		$d['data_p'] = $this->mod_bengkel->get_bengkel($id);
		$d['Kd_Pelanggan'] = $idpelanggan;
		$d['Kd_Perusahaan'] = $idperusahaan;
		$d['Kd_Izin'] = $this->kode_izin; //kode bengkel
		$d['Kd_Jenis'] = $jenis_izin;
	...
	public function tt($id=0)
	{
		...
		$d['menuactive'] = $this->class_izin.'_cetak';
		$d['Class_Izin'] = $this->class_izin;
		$d['Kd_Jenis_Izin'] = $Kd_Jenis_Izin = $this->mod_bengkel->get_jenis_izin($id);
		$d['Kd_Kategori_Izin'] = $Kd_Kategori_Izin = $this->mod_bengkel->get_kategori_izin($id);
		$d['data'] = $this->mod_bengkel->get_bengkel($id);
		$d['Kd_Izin'] = $this->kode_izin; //kode bengkel
		$d['Nm_Izin'] = $this->nama_izin; //kode bengkel
	...
	public function get_nomor($id=0,$param=0,$param2=0)
	{
		...
		$d['Kd_Jenis_Izin'] = $Kd_Jenis_Izin = $this->mod_bengkel->get_jenis_izin($id);
		$d['Kd_Kategori_Izin'] = $Kd_Kategori_Izin = $this->mod_bengkel->get_kategori_izin($id);
		$d['no_sk'] = $this->mod_bengkel->get_nomor_sk($id,$param,$param2); // Kode Param Manual
		$d['id_sk'] = $this->mod_bengkel->get_id_sk($id);;
		$d['Kd_Izin'] = $this->kode_izin; //kode bengkel
		$d['Nm_Izin'] = $this->nama_izin; //kode bengkel
	...
	public function get_agenda($id=0,$param=0)
	{
		...
		$d['Kd_Jenis_Izin'] = $Kd_Jenis_Izin = $this->mod_bengkel->get_jenis_izin($id);
		$d['Kd_Kategori_Izin'] = $Kd_Kategori_Izin = $this->mod_bengkel->get_kategori_izin($id);
		$d['no_agenda'] = $this->mod_bengkel->get_nomor_agenda($id,2); // Kode Param Manual
		$d['id_agenda'] = $this->mod_bengkel->get_id_agenda($id);;
		$d['Kd_Izin'] = $this->kode_izin; //kode bengkel
		$d['Nm_Izin'] = $this->nama_izin; //kode bengkel
	...
	public function op_perusahaan(){
		//if('IS_AJAX') {
			...
			$d['op_desa'] = $this->mod_bengkel->op_desa();
			$d['op_bentuk_perusahaan'] = $this->mod_bengkel->op_bentuk_perusahaan();
			$d['data'] = $this->mod_bengkel->get_data_perusahaan($idperusahaan);
			$d['data2'] = $this->mod_bengkel->get_data_bengkel($ID_Izin);
			$d['op_status_perusahaan'] = $this->mod_bengkel->op_status_perusahaan();
			$d['op_kategori_bengkel'] = $this->mod_bengkel->op_kategori_bengkel();
			$d['op_kegiatan_usaha'] = $this->mod_bengkel->op_kegiatan_usaha();
			$d['op_kelembagaan'] = $this->mod_bengkel->op_kelembagaan();
	...
	public function laporan()
	{
		$d = $this->mod_all->load();
		$d['DataAkses']	= $DataAkses = DataAkses($this->session->userdata('userid'));
		$d['PageAkses'] = PageAkses(257,$DataAkses);
	...
	public function report($start='',$end='')
	{
		...
		$d['Class_Izin'] = $this->class_izin;
		$d['data']	= $this->mod_bengkel->tbl_print($start,$end);
		$d['tgl_start'] = $start;
		$d['tgl_end'] = $end;
		$this->breadcrumb->append_crumb(lang('Dashboard'), site_url(fmodule()));
		$this->breadcrumb->append_crumb($title);
