...
class Mod_tdp extends CI_Model {
	...
	function get_tbl_tdp_fo($status=0,$limit=0,$offset=0){
		...
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbtdp.IDPELANGGAN WHERE tbtdp.Status = 1 AND tbtdp.FLOW = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_tdp_kabid($status=0,$limit=0,$offset=0){
		...
		tbtdp
		INNER JOIN tbperusahaan ON tbperusahaan.IDPERUSAHAAN = tbtdp.IDPERUSAHAAN
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbtdp.IDPELANGGAN WHERE tbtdp.Status = 1 AND tbtdp.FLOWA = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_tdp_kadin($status=0,$limit=0,$offset=0){
		...
		tbtdp
		INNER JOIN tbperusahaan ON tbperusahaan.IDPERUSAHAAN = tbtdp.IDPERUSAHAAN
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbtdp.IDPELANGGAN WHERE tbtdp.Status = 1 AND tbtdp.FLOWA = "1" and tbtdp.FLOWB = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_tdp_tu($status=0,$limit=0,$offset=0){
		...
		tbtdp
		INNER JOIN tbperusahaan ON tbperusahaan.IDPERUSAHAAN = tbtdp.IDPERUSAHAAN
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbtdp.IDPELANGGAN WHERE tbtdp.Status = 1 AND tbtdp.FLOWA = "1" and tbtdp.FLOWB = "1" and tbtdp.FLOWC = "'.$status.'" and tbtdp.FLOWD = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_tdp_cetak($status=0,$limit=0,$offset=0){
		...
		tbtdp
		INNER JOIN tbperusahaan ON tbperusahaan.IDPERUSAHAAN = tbtdp.IDPERUSAHAAN
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbtdp.IDPELANGGAN WHERE tbtdp.Status = 1 AND tbtdp.FLOWA = 1 and tbtdp.FLOWB = 1 and tbtdp.FLOWC = 1 and tbtdp.FLOWD = 1 AND tbtdp.FLOWE = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_tdp_rekom($status=0,$limit=0,$offset=0){
		$q_limit = '';
		$q_where = '';
		if($status==1){
			$q_order = 'ORDER BY ID DESC';
		...
		tbtdp
		INNER JOIN tbperusahaan ON tbperusahaan.IDPERUSAHAAN = tbtdp.IDPERUSAHAAN
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbtdp.IDPELANGGAN WHERE tbtdp.Status = 1 AND tbtdp.FLOW = 0 AND tbtdp.Flow_Rekom = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
