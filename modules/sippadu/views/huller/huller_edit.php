									...
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="pemilik" id="pemilik" placeholder="Pemilik" class="form-control" value="<?php echo set_value('pemilik',$d2->Pemilik); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Nomor Kode</label>
												<div class="col-sm-6"><input type="text" name="kode" id="kode" placeholder="Kode" class="form-control" value="<?php echo set_value('kode',$d2->Kode); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Kapasitas Potensial</label>
												<div class="col-sm-6"><input type="text" name="kapasitas" id="kapasitas" placeholder="Kapasitas Potensial" class="form-control" value="<?php echo set_value('kapasitas',$d2->Kapasitas); ?>" /></div>
											</div>
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Keterangan Detail Alat</label>
											   <div class="col-sm-10"><textarea name="keterangan_alat" class="summernote"><?php echo ($d2->Keterangan_Alat != '' ? $d2->Keterangan_Alat : format_parameter($Kd_Izin,51,$replace)); ?></textarea></div>
											</div>
											<!--<div class="form-group">
											...
											<div class="form-group">
											   ...
											   <div class="col-sm-10"><textarea name="tembusan" class="summernote"><?php echo set_value('tembusan',$d2->Tembusan); ?></textarea></div>
											</div>
											<?php } ?>
