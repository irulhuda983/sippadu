...
<body class="no-border">
	...
	<table  class="tb100 font10" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;padding-left:0px;">
		<tr>
			...
			<td width="20">:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,41,$replace); ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,42,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,43,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>
		...
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,44,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,45,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,46,$replace); ?></td>
		</tr>
	</table>
	<br/>
	<br/>
