								...
								<?php echo form_open('',array('name' => 'form', 'id' => 'form')); ?>
									<div class="tile-widget">
										...
										<div class="row">
											...
											<div class="col-sm-8">
												<input class="btn btn-blue" type="button" id="add" value="Tambah Data" onclick="window.location.href='<?php echo site_url(fmodule('setting/mod_izin_add')); ?>'"/>
											...
											<table  class="table table-hover" id="" style="">
												<thead>
													<tr class="active">                                    
														...
														<th width="">Class</th>
														<th width="20px">SK1</th>
														<th width="20px">SK2</th>
														<th width="20px">Rekom</th>
														<th width="20px">Online</th>
													...
													<?php
														if($data->num_rows() > 0){
															foreach($data->result() as $d){
																echo '
																<tr>                                    
																	<td class="center"><label class="checkbox checkbox-custom-alt checkbox-custom-sm m-0">'.form_checkbox('chk[]',$d->Kd_Izin).'<i></i></label></td>
																	<td>'.$d->Kd_Izin.'</td>
																	<td>'.$d->Nm_Izin.'</td>
																	<td>'.$d->Kd_Class.'</td>
																	<td align="center">'.icon_status($d->SK1).'</td>	
																	<td align="center">'.icon_status($d->SK2).'</td>
																	<td align="center">'.icon_status($d->Kd_Rekom).'</td>		
																	<td align="center">'.icon_status($d->Reg_Online).'</td>	
																	<td align="center">'.icon_status($d->Status).'</td>	
																	<td align="center">'.icon_edit(site_url(fmodule('setting/mod_izin_edit/'.$d->Kd_Izin))).'</td>	
																</tr>  '; 
															}
														}
													?>
