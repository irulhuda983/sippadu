									...
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="nama_usaha" id="nama_usaha" placeholder="Nama Laboratorium" class="form-control" value="<?php echo set_value('nama_usaha',$d2->Nm_Usaha); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Alamat</label>
												<div class="col-sm-6"><input type="text" name="alamat_usaha" id="alamat_usaha" placeholder="Alamat Laboratorium" class="form-control" value="<?php echo set_value('alamat_usaha',$d2->Alamat_Usaha); ?>" /></div>
											</div> 
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="penanggungjawab" id="penanggungjawab" placeholder="Penanggung Jawab" class="form-control" value="<?php echo set_value('penanggungjawab',$d2->Penanggungjawab); ?>" /></div>
											</div> 
											<!--<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													if($Kd_Rekom == 1 && ($Kd_Access == 'bo' || $Kd_Access == 'tu' || $Kd_Access == 'rekom')) {
														...
														<a href="'.site_url('/sendRekom/rekomLapKlinik/'.$ID_Izin).'" class="btn btn-info kirim-rekom">Kirim Rekom Ke Dinkes</a>
														';
													} 
