                                ...
                                <div class="tile-body">
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Ket. Lampiran</label>
											   <div class="col-sm-10"><textarea name="ket_lampiran" class="summernote"><?php echo ($d2->Ket_Lampiran != '' ? $d2->Ket_Lampiran : format_parameter($Kd_Izin,51,$replace)); ?></textarea></div>
											</div>
											<div class="form-group">
