                                        ...
                                        <ul id="navigation">
											...
											<?php echo GroupMenuAkses(array(40),$DataAkses,'<li class="'.menuopen('personal',$menuopen).'">
												...
												<ul>
													...
													'.MenuAkses(40,$DataAkses,'<li class="'.menuactive('personal_klaim',$menuactive).'"><a href="'.site_url(fmodule('personal/klaim')).'"><i class="fa fa-circle-o"></i><span class="text">Klaim Data Personal</span></a></li>').'
												</ul>
											</li>'); ?>
											
											<?php echo GroupMenuAkses(array(50,60,70,80,90,100,110,120,130,140,150,160,170,180,190,200,210),$DataAkses,'<li class="'.menuopen('fo',$menuopen).'">
											...
											<?php echo GroupMenuAkses(array(58,68,78,88,98,108,118,128,138,148,158,168,178,188,198,208,218),$DataAkses,'<li class="'.menuopen('rekom',$menuopen).'">
												<a role="button" href="'.site_url(fmodule('sippadu/rekom')).'"><i class="fa fa-thumbs-o-up"></i> <span>Rekomendasi</span> <span class="ntf_subtotal_rekom"></a></li>'); ?>
											
											<?php echo GroupMenuAkses(array(51,61,71,81,91,101,111,121,131,141,151,161,171,181,191,201,211),$DataAkses,'<li class="'.menuopen('bo',$menuopen).'">
											...
											<?php echo GroupMenuAkses(array(52,62,72,82,92,102,112,122,132,142,152,162,172,182,192,202,212),$DataAkses,'<li class="'.menuopen('kabid',$menuopen).'">
											...
											<?php echo GroupMenuAkses(array(53,63,73,83,93,103,113,123,133,143,153,163,173,183,193,203,213),$DataAkses,'<li class="'.menuopen('kadin',$menuopen).'">
											...
											<?php echo GroupMenuAkses(array(54,64,74,84,94,104,114,124,134,144,154,164,174,184,194,204,214),$DataAkses,'<li class="'.menuopen('tu',$menuopen).'">
											...
											<?php echo GroupMenuAkses(array(55,65,75,85,95,105,115,125,135,145,155,165,175,185,195,205,215),$DataAkses,'<li class="'.menuopen('cetak',$menuopen).'">
											...
											<?php echo GroupMenuAkses(array(56,66,76,86,96,106,116,126,136,146,156,166,176,186,196,206,216),$DataAkses,'<li class="'.menuopen('serah',$menuopen).'">
											...
											<?php echo GroupMenuAkses(array(57,67,77,87,97,107,117,127,137,147,157,167,177,187,197,207,217),$DataAkses,'<li class="'.menuopen('laporan',$menuopen).'">
												<a role="button" href="'.site_url(fmodule('lap_izin')).'"><i class="fa fa-file-o"></i> <span>Laporan</span></a>
												<ul>
													'.GroupMenuAkses(array(57,67,77,87,97,107,117,127,137,147,157,167,177,187,197,207,217),$DataAkses,'<li class="'.menuactive('rekap_laporan',$menuactive).'"><a href="'.site_url(fmodule('laporan')).'"><i class="fa fa-circle-o"></i><span class="text">Laporan Semua Izin</span></a></li>').'
													'.GroupMenuAkses(array(57,67,77,87,97,107,117,127,137,147,157,167,177,187,197,207,217),$DataAkses,'<li class="'.menuactive('rekap_laporan_izin',$menuactive).'"><a href="'.site_url(fmodule('sippadu/laporan')).'"><i class="fa fa-circle-o"></i><span class="text">Laporan Per Izin</span></a></li>').'
												</ul>
											</li>'); ?>
											...
											<?php echo GroupMenuAkses(array(33,35,36),$DataAkses,'<li class="'.menuopen('setting',$menuopen).'">
												...
												<ul>
													...
													'.MenuAkses(36,$DataAkses,'<li class="'.menuactive('setting_skpd_rekom',$menuactive).'"><a href="'.site_url(fmodule('setting/skpd_rekom')).'"><i class="fa fa-circle-o"></i><span class="text">SKPD Rekomendasi</span></a></li>').'
												</ul>
											</li>'); ?>
