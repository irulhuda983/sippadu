									...
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="nama_usaha" id="nama_usaha" placeholder="Nama Perusahaan" class="form-control" value="<?php echo set_value('nama_usaha'); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Alamat Perusahaan</label>
												<div class="col-sm-6"><input type="text" name="alamat_usaha" id="alamat_usaha" placeholder="Alamat Perusahaan" class="form-control" value="<?php echo set_value('alamat_usaha'); ?>" /></div>
											</div> 
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Lokasi Kegiatan</label>
												<div class="col-sm-6"><input type="text" name="lokasi" id="lokasi" placeholder="Lokasi Kegiatan" class="form-control" value="<?php echo set_value('lokasi'); ?>" /></div>
											</div> 
													
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Penanggung Jawab</label>
												<div class="col-sm-6"><input type="text" name="penanggungjawab" id="penanggungjawab" placeholder="Penanggung Jawab" class="form-control" value="<?php echo set_value('penanggungjawab'); ?>" /></div>
											</div> 
