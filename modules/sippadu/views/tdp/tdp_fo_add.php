                                ...
                                <div class="tile-body form-horizontal">
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><?php echo form_dropdown('jenis_izin',array('0'=>'- Pilih Jenis -','1'=>'Baru','2'=>'Perpanjangan','3'=>'Perubahan'),set_value('jenis_izin',$Kd_Jenis),'id="jenis_izin" class="form-control"'); ?></div>
											</div>
											<div class="form-group">
