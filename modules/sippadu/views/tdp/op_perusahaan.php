...
<?php if($Kd_Access == 'bo' || $Kd_Access == 'tu' || $Kd_Access == 'rekom') { ?>
...
<span id="dsp_agenda" style="display:none;">
	<div class="form-group">
		...
		<div class="col-sm-2"><input type="button" class="btn btn-blue" value="Buat Nomor Agenda"  onclick="popup('<?php echo site_url(fmodule($Class_Izin.'/get_agenda/'.$ID_Izin)); ?>')"/></div>
	</div> 
	<div class="form-group">
