...
<html class="no-js" lang="">
    ...
    <body id="minovate" class="appWrapper">
                ...
                <div class="page">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
							...
							<section class="tile" id="pilih-jenis">
								<div class="tile-body">
										<div class="form-group">
											<label for="jenis-reg">Pilih Jenis Registrasi</label>
											<select class="form-control" id="jenis-reg">
												<option value="0">Silahkan Pilih Jenis Registrasi</option>
												<option value="1">Registrasi Umum</option>
												<option value="2">Registrasi Pemerintah</option>
											</select>
										</div>
								</div>
							</section>

							<section class="tile" id="cek-nop" style="display: none">
								<div class="tile-header dvd dvd-btm">
									<div class="row">
										<div class="col-md-11">
											<h1 class="custom-font">Cek Data PBB</h1>
										</div>

										<div class="col-md-1">
											<button class="btn btn-block btn-danger batal">Batal</button>
										</div>
									</div>
								</div>

								<div class="tile-body">
									<form action="#" method="post" id="form-nop">
										<div class="form-group row">
												<label for="" class="col-sm-2 control-label">No Surat Permohonan</label>
												<div class="col-sm-6"><input type="text" name="nop" id="nop" placeholder="No Surat Permohonan" class="form-control"  />
                            ...
                            <!-- tile -->
                            <section class="tile" id="reg" style="display: none;">
		...
		<script type="text/javascript">
            ...
            const formNop = document.getElementById('form-nop')
            const reg = document.getElementById('reg')
			const cekNop = document.getElementById('cek-nop')
			const pilihReg = document.getElementById('jenis-reg')
			const pilihJenis = document.getElementById('pilih-jenis')
			const url = "<?= site_url('imb/getDataPbb'); ?>"

			pilihReg.addEventListener('change', (e) => {
				e.preventDefault()

				if(pilihReg.value == 0){
					Swal.fire({
                        icon: 'error',
                        title: 'Pilih jenis registrasi terlebih dahulu'
                    })
				}else if(pilihReg.value == 1){
					pilihJenis.style.display='none'
					cekNop.style.display='block'
                    reg.style.display='none';
				}else if(pilihReg.value == 2){
					pilihJenis.style.display='none'
					cekNop.style.display='none'
			...
			formNop.addEventListener('submit', (e) => {
				e.preventDefault()
