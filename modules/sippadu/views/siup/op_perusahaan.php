...
<div class="form-group">
	...
	<div class="col-sm-6"><?php echo form_dropdown('op_kategori_siup',$op_kategori_siup,set_value('op_kategori_siup',$kategori_izin),'id="el" class="form-control chosen-select"'); ?></div>
</div>
<div class="form-group">
	<label for="" class="col-sm-2 control-label">Status Usaha</label>
	<div class="col-sm-6"><?php echo form_dropdown('op_status_perusahaan',$op_status_perusahaan,set_value('op_status_perusahaan',$status_perusahaan),'id="op_status_perusahaan" class="form-control chosen-select"'); ?></div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-sm-6"><?php echo form_dropdown('op_kegiatan_usaha',$op_kegiatan_usaha,set_value('op_kegiatan_usaha',$keg_usaha),'id="op_kegiatan_usaha" class="form-control chosen-select"'); ?></div>
</div>

<div class="form-group">
	<label for="" class="col-sm-2 control-label">Kelembagaan</label>
	<div class="col-sm-6"><?php echo form_dropdown('op_kelembagaan',$op_kelembagaan,set_value('op_kelembagaan',$kelembagaan),'id="op_kelembagaan" class="form-control chosen-select"'); ?></div>
</div>
<div class="form-group">
