...
<html class="no-js" lang="">
    ...
    <body id="minovate" class="appWrapper">
                                ...
                                <div class="tile-body form-horizontal">
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><?php echo form_dropdown('jenis_izin',array('0'=>'- Pilih Jenis -','1'=>'Baru','2'=>'Perpanjangan','3'=>'Perubahan'),set_value('jenis_izin',$Kd_Jenis),'id="jenis_izin" class="form-control chosen-select"'); ?></div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Bentuk Perusahaan</label>
											...
											<div class="form-group">
												<div class="col-sm-2 control-label">Dokumen</div>
												<div class="col-sm-10">
													<?php foreach($data_dok->result() as $dok){ 
													$cek = cek_dok_checklist($Kd_Pelanggan,$Kd_Perusahaan,$Kd_Izin,$Kd_Jenis,$dok->Kd_Dok);
													?>
		...
		$("#op_perusahaan").change(function(){
			$.ajax({
					type: "POST",
					url : "<?php echo site_url(fmodule('op_perusahaan')); ?>/?time=" + new Date().getTime(),
