										...
										<div class="block-fluid">                        
											...
											<span id="dsp_perusahaan">
												...
												<div class="form-group">
													...
													<div class="col-sm-6"><?php echo form_dropdown('op_kategori_siup',$op_kategori_siup,set_value('op_kategori_siup'),'id="op_kategori_siup" class="form-control"'); ?></div>
												</div>
												<div class="form-group">
													<label for="" class="col-sm-2 control-label">Status Usaha</label>
													<div class="col-sm-6"><?php echo form_dropdown('op_status_perusahaan',$op_status_perusahaan,set_value('op_status_perusahaan'),'id="op_status_perusahaan" class="form-control"'); ?></div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-sm-6"><?php echo form_dropdown('op_kegiatan_usaha',$op_kegiatan_usaha,set_value('op_kegiatan_usaha'),'id="op_kegiatan_usaha" class="form-control"'); ?></div>
												</div>
												
												<div class="form-group">
													<label for="" class="col-sm-2 control-label">Kelembagaan</label>
													<div class="col-sm-6"><?php echo form_dropdown('op_kelembagaan',$op_kelembagaan,set_value('op_kelembagaan'),'id="op_kelembagaan" class="form-control"'); ?></div>
												</div>
												<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-4"><input type="text" name="no_sk" id="no_sk" placeholder="No SK" class="form-control" value="<?php echo set_value('no_sk'); ?>" /></div>
												<div class="col-sm-2"><input type="button" class="btn btn-blue" value="Buat Nomor SK"/></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">No. Urut SK</label>
												<div class="col-sm-2"><input type="text" name="no_urut_sk" id="no_urut_sk" placeholder="No Urut SK" class="form-control" value="<?php echo set_value('no_urut_sk'); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Tanggal SK:</label>
												<div class="col-sm-2"><div class="input-group datepicker" data-format="DD/MM/YYYY"><?php echo form_input('tgl_sk',set_value('tgl_sk',TimeNow('d/m/Y')),'class="form-control" id="mask_date" placeholder="Isikan Tanggal"'); ?>
												<span class="input-group-addon"><span class="fa fa-calendar"></span></span></div>
												</div>
											</div>  
											<?php } ?>
