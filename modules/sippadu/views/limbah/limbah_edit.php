									...
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="jabatan_pemohon" id="jabatan_pemohon" placeholder="Jabatan Pemohon" class="form-control" value="<?php echo set_value('penanggungjawab',$d2->Jabatan_Pemohon); ?>" /></div>
											</div> 
											<div class="form-group">
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">No Surat LH</label>
												<div class="col-sm-6"><input type="text" name="no_suratlh" id="no_suratlh" placeholder="Nomor Surat LH" class="form-control" value="<?php echo set_value('no_suratlh',($d2->No_SuratLH != '' ? $d2->No_SuratLH : format_parameter($Kd_Izin,111,$replace))); ?>"/></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Tanggal Surat LH:</label>
												<div class="col-sm-2"><div class="input-group datepicker" data-format="DD/MM/YYYY"><?php echo form_input('tgl_suratlh',set_value('tgl_suratlh',TimeFormat($d2->Tgl_Surat_Rekom,'d/m/Y')),'class="form-control" id="mask_date" placeholder="Isikan Tanggal" '); ?>
												<span class="input-group-addon"><span class="fa fa-calendar"></span></span></div>
												</div>
											</div>  
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Perihal Surat LH</label>
												<div class="col-sm-6"><input type="text" name="perihal_suratlh" id="perihal_suratlh" placeholder="Perihal Surat LH" class="form-control" value="<?php echo set_value('perihal_suratlh',($d2->Perihal_SuratLH != '' ? $d2->Perihal_SuratLH : format_parameter($Kd_Izin,112,$replace))); ?>" /></div>
											</div> 
											<div class="form-group">
