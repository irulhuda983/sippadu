									...
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="jenis_usaha" id="jenis_usaha" placeholder="Jenis Usaha" class="form-control" value="<?php echo set_value('jenis_usaha'); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Jabatan Pemohon</label>
												<div class="col-sm-6"><input type="text" name="jabatan_pemohon" id="jabatan_pemohon" placeholder="Jabatan Pemohon" class="form-control" value="<?php echo set_value('penanggungjawab'); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Penanggungjawab</label>
												<div class="col-sm-6"><input type="text" name="penanggungjawab" id="penanggungjawab" placeholder="Penanggungjawab" class="form-control" value="<?php echo set_value('penanggungjawab'); ?>" /></div>
											</div> 
