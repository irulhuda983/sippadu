    ...
    <body id="minovate" class="appWrapper">
									...
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="sebab" id="sebab" placeholder="Sebab Penutupan" class="form-control" value="<?php echo set_value('sebab'); ?>" /></div>
											</div> 
											</span>
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="jabatan_pemohon" id="jabatan_pemohon" placeholder="Jabatan Pemohon" class="form-control" value="<?php echo set_value('jabatan_pemohon','Apoteker'); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Nama Pemilik Apotek</label>
												<div class="col-sm-6"><input type="text" name="nama_pemilik" id="nama_pemilik" placeholder="Nama Pemilik" class="form-control" value="<?php echo set_value('nama_pemilik'); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Nama Apoteker</label>
												<div class="col-sm-6"><input type="text" name="nama_apoteker" id="nama_apoteker" placeholder="Nama Apoteker" class="form-control" value="<?php echo set_value('nama_apoteker'); ?>" /></div>
											</div> 
											<div class="form-group">
		...
		<script type="text/javascript">
			...
			$("#jenis_izin").change(function(){
				...
				if(status=='4'){
					document.getElementById('dsp_sebab').style.display='';
				}
				else{
					document.getElementById('dsp_sebab').style.display='none';
				}
			});
