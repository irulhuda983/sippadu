									...
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="sebab" id="sebab" placeholder="Sebab Penutupan" class="form-control" value="<?php echo set_value('sebab',$d2->Sebab_Penutupan); ?>" /></div>
											</div> 
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="nama_pemilik" id="nama_pemilik" placeholder="Nama Pemilik" class="form-control" value="<?php echo set_value('nama_pemilik',$d2->Pemilik_Usaha); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Nama Apoteker</label>
												<div class="col-sm-6"><input type="text" name="nama_apoteker" id="nama_apoteker" placeholder="Nama Apoteker" class="form-control" value="<?php echo set_value('nama_apoteker',$d2->Nm_Apoteker); ?>" /></div>
											</div> 
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													if($Kd_Rekom == 1 && ($Kd_Access == 'bo' || $Kd_Access == 'tu' || $Kd_Access == 'rekom')) {
														echo '
														<a href="'.site_url('/sendRekom/rekomApotek/'.$ID_Izin).'" class="btn btn-info">Minta Rekom Ke Dinkes</a>
														';
													} 
