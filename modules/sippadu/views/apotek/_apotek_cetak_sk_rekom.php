...
<body class="no-border">
	<table class="tb100" border="0" align="center" cellpadding="0" cellspacing="0" style="">
		...
		<tr>
			<td rowspan="5"  align="center" valign="top" class=""><img src="<?php echo base_url(); ?>assets/<?php echo config('theme'); ?>/images/<?php echo sippadu_rekom('logo_warna'); ?>" width="60px" /></td>
			<td height="" class="font10 black bold tcenter ttop"><div align="center"><?php echo strtoupper(sippadu_rekom('nama_pemda')); ?></div></td></tr>
		<tr>
			<td height="" class="font11 black bold tcenter ttop"><div align="center"><?php echo strtoupper(sippadu_rekom('nama_dinas')); ?></div></td>
		</tr>
		<tr>
			<td height="" class="font9 black tcenter ttop"><div align="center"><?php echo sippadu_rekom('alamat_dinas'); ?></div></td>
		</tr>
		<tr>
			<td colspan="1" align="center" valign="top" class="font9 black"><div align="center">Website: <?php echo ifnull(sippadu_rekom('web_dinas'),'-'); ?>&nbsp;&nbsp;&nbsp;Email: <?php echo ifnull(sippadu_rekom('email_dinas'),'-'); ?></div></td>
		</tr>
		<tr>
		   <td class="font16 black tcenter ttop" style="padding-top: 2px;"><div align="center"><b><u><?php echo strtoupper(sippadu_rekom('nama_kota')); ?></u></b></div></td>
		</tr>
	</table>
	...
	<!--<table class="tb100 font10" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;padding-left:0px;">
		<tr>
			<td ALIGN="center"><b>KEPUTUSAN<br/>KEPALA <?php echo str_replace('DAN PELAYANAN','DAN PELAYANAN',sippadu_rekom('nama_dinas')).'<br/>'.strtoupper(sippadu_rekom('nama_kota2')); ?></b></td>
		</tr>
		<tr>
			<td ALIGN="center">&nbsp;</td>
		</tr>
		...
		<tr>
			<td ALIGN="center"><b>TENTANG<br/>SURAT IZIN APOTEK</b></td>
		</tr>
		<tr>
			<td ALIGN="center">&nbsp;</td>
		</tr>
		<tr>
			<td ALIGN="center"><b>KEPALA <?php echo str_replace('DAN PELAYANAN','DAN PELAYANAN',sippadu_rekom('nama_dinas')); ?></b></td>
		</tr>
	</table>
	<br/>
	<table  class="tb100 font10" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;padding-left:0px;">
	...
	<table class="font10 tbtgl fright tleft" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;padding-left:0px;">
		<tr>
			...
			<td>:</td>
			<td><?php echo sippadu_rekom('nama_kota'); ?></td>
		</tr>
		<tr>
	...
	<table class="font10 tbttd fright" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;padding-left:0px;">
		<tr>
			<td align="center"><b><?php echo str_replace('DAN PELAYANAN','<br/>DAN PELAYANAN',sippadu_rekom('nama_jabatan')); ?><br/><?php echo strtoupper(sippadu_rekom('nama_kota2')); ?></b></td>
		</tr>
		<tr>
			<td align="center"><?php echo imgttd($d->Flow_Kadin,300,'','','','0'); ?><br/><br/><br/><br/><br/><u><b><?php echo sippadu_rekom('nama_kadin'); ?></b></u><br/><?php echo sippadu_rekom('pangkat_kadin'); ?><br/>NIP. <?php echo sippadu_rekom('nip_kadin'); ?></td>
		</tr>
	</table>-->
