...
<body class="no-border">
	...
	<table class="tb100 font10" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;padding-left:0px;">
		...
		<tr>
			<td ALIGN="center"><b>TENTANG<br/><?php echo strtoupper(format_parameter($Kd_Izin,70,$replace)); ?></b></td>
		</tr>
		<tr>
			<td ALIGN="center">&nbsp;</td>
		</tr>
	...
	<table  class="tb100 font10" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;padding-left:0px;">
		<tr>
			...
			<td width="20">:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,71,$replace); ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,72,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left"><b>Memperhatikan</b></td>
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,73,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>
		...
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,74,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,75,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,76,$replace); ?></td>
		</tr>
	</table>
	<br/>
	<br/>
