...
<body class="no-border">
	...
	<table class="tb100 font10" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;padding-left:0px;">
		...
		<tr>
			<td ALIGN="center"><b>TENTANG<br/><?php echo strtoupper(format_parameter($Kd_Izin,60,$replace)); ?></b></td>
		</tr>
		<tr>
			<td ALIGN="center">&nbsp;</td>
		</tr>
	...
	<table  class="tb100 font10" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;padding-left:0px;">
		<tr>
			...
			<td width="20">:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,61,$replace); ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,62,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left"><b>Memperhatikan</b></td>
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,63,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>
		...
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,64,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,65,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,66,$replace); ?></td>
		</tr>
	</table>
	<br/>
	<br/>
