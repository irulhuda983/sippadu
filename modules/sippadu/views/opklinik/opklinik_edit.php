									...
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><?php echo form_dropdown('kategori_izin',$op_kategori_izin,set_value('kategori_izin',$d2->Kategori),'id="kategori_izin" class="form-control"'); ?></div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="pemilik" id="pemilik" placeholder="Nama Pemilik" class="form-control" value="<?php echo set_value('pemilik',$d2->Pemilik); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Penanggungjawab</label>
												<div class="col-sm-6"><input type="text" name="penanggungjawab" id="penanggungjawab" placeholder="Nama Penanggungjawab" class="form-control" value="<?php echo set_value('penanggungjawab',$d2->Penanggungjawab); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Jenis Klinik</label>
												<div class="col-sm-6"><input type="text" name="jenis_klinik" id="jenis_klinik" placeholder="Jenis Klinik" class="form-control" value="<?php echo set_value('jenis_klinik',$d2->Jenis_Klinik); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Jenis Pelayanan</label>
												<div class="col-sm-6"><input type="text" name="jenis_pelayanan" id="jenis_pelayanan" placeholder="Jenis Pelayanan" class="form-control" value="<?php echo set_value('jenis_pelayanan',$d2->Jenis_Pelayanan); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">No. Akta Pendirian</label>
												<div class="col-sm-6"><input type="text" name="akta_pendirian" id="akta_pendirian" placeholder="Akta Pendirian" class="form-control" value="<?php echo set_value('akta_pendirian',$d2->Akta_Pendirian); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Tanggal Akta:</label>
												<div class="col-sm-2"><div class="input-group datepicker" data-format="DD/MM/YYYY"><?php echo form_input('akta_tanggal',set_value('akta_tanggal',TimeFormat($d2->Akta_Tanggal,'d/m/Y')),'class="form-control" id="mask_date" placeholder="Isikan Tanggal"'); ?>
												<span class="input-group-addon"><span class="fa fa-calendar"></span></span></div>
												</div>
											</div>  
											<?php } ?>
											...
											<!--<div class="form-group">
												<label for="" class="col-sm-2 control-label">Judul Izin</label>
											   <div class="col-sm-10"><textarea name="judul" id="summernote"><?php echo set_value('judul',set_value('judul',($d2->Judul_Izin != '' ? $d2->Judul_Izin : format_parameter($Kd_Izin,10,$replace)))); ?></textarea></div>
											</div>
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Judul Izin</label>
												<div class="col-sm-6"><input type="text" name="judul" id="judul" placeholder="Judul Izin" class="form-control" value="<?php echo set_value('judul',$d2->Judul_Izin); ?>" /></div>
											</div>-->
											<!--<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													if($Kd_Rekom == 1 && ($Kd_Access == 'bo' || $Kd_Access == 'tu' || $Kd_Access == 'rekom')) {
														...
														<a href="'.site_url('/sendRekom/rekomKlinik/'.$ID_Izin).'" class="btn btn-info">Kirim Rekom Ke Dinkes</a>
														';
													} 
