...
<body class="no-border">
	...
	if($data->num_rows() > 0){ 
	$d = $data->row(); ?>
	<table class="tb100 font12" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;width:80%;margin:0 auto;margin-top:50px;">
		<tr>
			<td align="justify"><?php echo format_parameter($Kd_Izin,52,$replace); ?></td>
		</tr>
	</table>
