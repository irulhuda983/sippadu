...
<body class="no-border">
	...
	<table class="tb100 font10" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;padding-left:0px;">
		...
		<tr>
			<td ALIGN="center"><b>TENTANG<br/>IZIN PENYELENGGARAAN OPTIK</b></td>
		</tr>
		<tr>
			<td ALIGN="center">&nbsp;</td>
		</tr>
	...
	<table  class="tb100 font10" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;padding-left:0px;">
		<tr>
			...
			<td width="20">:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,21,$replace); ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,22,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left"><b>MEMPERHATIKAN</b></td>
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,23,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>
		...
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,24,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,25,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,26,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>
		<tr>
			<td ALIGN="left"><b>Keempat</b></td>
			<td>:</td>
			<td align="justify"><?php echo format_parameter($Kd_Izin,27,$replace); ?></td>
		</tr>
	</table>
	<br/>
	<br/>
	...
	<br/>
	<br/>
	<table class="font10 tbttd2 fright" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;padding-left:0px;">
		<tr>
