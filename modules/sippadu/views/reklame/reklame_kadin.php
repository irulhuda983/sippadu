									...
									<div class="tile-widget">
										...
										<div class="row">
											...
											<div class="col-sm-8">
												...
												<input class="btn btn-greensea" type="button" name="add" value="Antrian" onclick="window.location.href='<?php echo site_url(fmodule($Class_Izin.'/kadin')); ?>'"/>
												<input class="btn btn-dutch" type="button" name="add" value="Arsip" onclick="window.location.href='<?php echo site_url(fmodule($Class_Izin.'/kadin_all')); ?>'"/>
											</div>
											...
											<table  class="table table-hover" id="" style="font-size:12px;">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<a href="#" class="btn btn-danger btn-sm btn-esign" data-id="<?= $d['ID']; ?>" data-url="<?= site_url('Api/getDataTteReklame'); ?>">Esign</a>
															<a href="<?= site_url(fmodule($Class_Izin.'/sk/'.$d['ID'])); ?>" class="btn btn-primary btn-sm" target="_blank">Preview</a>	
														</td>
													</tr>
													<?php
													endforeach;
