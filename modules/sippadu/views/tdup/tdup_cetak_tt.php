			...
			<td>
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="">
					...
					<tr>
						...
						<td valign="middle" class="style7">:</td>
						<td valign="middle" colspan="2" class="style7"><?php echo strtoupper(ifnull($d->Nm_Usaha,'-')); ?></td>
					</tr>
					<tr>
						<td valign="middle" class="style7">Jenis Usaha </td>
						<td valign="middle" class="style7">:</td>
						<td valign="middle" colspan="2" class="style7"><?php echo strtoupper(ifnull($d->Perihal,'-')); ?></td>
					</tr>
					<tr>
