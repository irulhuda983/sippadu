									...
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><?php echo form_dropdown('jenis_usaha',$op_kategori_iujk,set_value('jenis_usaha',$d2->Jenis_Usaha),'id="jenis_usaha" class="form-control chosen-select"'); ?></div>
											</div> 
											<div class="form-group">
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Klasifikasi (Detail)</label>
											   <div class="col-sm-10"><textarea name="klasifikasi_detail" class="summernote"><?php echo ($d2->Klasifikasi_Detail != '' ? $d2->Klasifikasi_Detail : format_parameter($Kd_Izin,51,$replace)); ?></textarea></div>
											</div>
											<!--<div class="form-group">
