...
<body class="page-border">
	...
	<table class="tb100 font10" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;padding-left:0px;">
		...
		<tr>
			<td ALIGN="center"><b>TENTANG<br/>ALIH FUNGSI IJIN GANGGUAN ( HO )</b></td>
		</tr>
		<tr>
			<td ALIGN="center">&nbsp;</td>
		</tr>
	...
	<table class="font10 tb100" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;padding-left:0px;">
		<tr>
			...
			<td width="20">:</td>
			<td align="justify"><?php echo format_parameter(4,31,$replace); ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter(4,32,$replace); ?></td>
		</tr>
		<!--<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>-->
		...
		<tr>
			<td ALIGN="center" colspan="3"><br/><b>MEMUTUSKAN</b></td>
		</tr>
		<!--<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>-->
		...
		<tr>
			...
			<td>:</td>
			<td align="justify">
			Mengubah Ijin Gangguan (HO) kepada:<br/>
			<table>
				<tr>
					<td width="13px">1.</td>
		...
		<tr>
			...
			<td>:</td>
			<td align="justify"><?php echo format_parameter(4,34,$replace); ?></td>
		</tr>
		<tr>
			<td ALIGN="left" colspan="3">&nbsp;</td>
		</tr>
