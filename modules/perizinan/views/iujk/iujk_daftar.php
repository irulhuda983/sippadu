                                ...
                                <div class="tab-pane" id="tab2">
                                    ...
                                    <div name="step2" class="form-horizontal" role="form">
										...
										<div class="form-group">
											...
											<div class="col-sm-2"><input type="text" name="rt_usaha" id="rt_usaha" placeholder="RT" class="form-control" value="<?php echo set_value('rt_usaha',$rt_usaha); ?>" /></div>
											<div class="col-sm-2"><input type="text" name="rw_usaha" id="rw_usaha" placeholder="RW" class="form-control" value="<?php echo set_value('rw_usaha',$rw_usaha); ?>" /></div>
											<div class="col-sm-2"><input type="text" name="kodepos_usaha" id="kodepos_usaha" placeholder="Kodepos" class="form-control" value="<?php echo set_value('kodepos_usaha',$kodepos_usaha); ?>" /></div>
										</div>
										<div class="form-group">
											<label for="" class="col-sm-2 control-label">Telepon</label>
											<div class="col-sm-6"><input type="text" name="telp_usaha" id="telp_usaha" placeholder="Telepon Usaha" class="form-control" value="<?php echo set_value('telp_usaha',$telp_usaha); ?>" /></div>
										</div>
										<div class="form-group">
											<label for="" class="col-sm-2 control-label">Fax</label>
											<div class="col-sm-6"><input type="text" name="fax_usaha" id="fax_usaha" placeholder="Fax Usaha" class="form-control" value="<?php echo set_value('fax_usaha',$fax_usaha); ?>" /></div>
										</div>
										<!--<div class="form-group">
