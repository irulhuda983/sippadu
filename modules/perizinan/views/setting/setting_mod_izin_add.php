									...
									<?php echo form_open('',array('class' => 'form-horizontal', 'role' => 'form')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><?php echo form_input('Nm_Izin',set_value('Nm_Izin'),'class="form-control"'); ?></div>
											</div>                         

											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Kode Class</label>
												<div class="col-sm-6"><?php echo form_input('Kd_Class',set_value('Kd_Class'),'class="form-control"'); ?></div>
											</div> 
