                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-body">
											...
											if($data2->num_rows() > 0){ $d2 = $data2->row(); ?>
											...
											<?php echo form_hidden('no_mohon',$d2->NO_MOHON); ?>
											<?php echo form_hidden('tgl_mohon',TimeFormat($d2->TGL_MOHON,'d/m/Y')); ?> 
											<?php echo form_hidden('op_pengurus_permohonan',substr($d2->STATUS_PENGURUS,-1)); ?> 
