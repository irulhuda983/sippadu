				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="">
					<tr>
						...
						<td width="500" rowspan="4" align="right" valign="top" class="style7">
							...
							jQuery('#barcode').barcode("<?php echo $d->IDSIUP; ?>","code128",settings);
							</script>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width="16" valign="middle" class="style7">:</td>
						<td valign="middle" class="style7"><b><?php echo $d->IDSIUP; ?></b></td>
					</tr>
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="">
					<tr>
						...
						<td width="500" rowspan="4" align="right" valign="top" class="style7">
							...
							jQuery('#barcode2').barcode("<?php echo $d->IDSIUP; ?>","code128",settings);
							</script>
						</td>
					</tr>
					<tr>
