			...
			<td>
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="">
					<tr>
						...
						<td width="500" rowspan="4" align="right" valign="top" class="style7">
							...
							jQuery('#barcode').barcode("<?php echo $d->ID_Reg; ?>","code128",settings);
							</script>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width="16" valign="middle" class="style7">:</td>
						<td valign="middle" class="style7"><b><?php echo $d->ID_Reg; ?></b></td>
					</tr>
					
					<tr>
						<td valign="middle" class="style7">Nama Pendaftar </td>
						<td valign="middle" class="style7">:</td>
						<td valign="middle" class="style7"><?php echo strtoupper(pelanggan($d->ID_Pelanggan,'nama')); ?></td>
						<td></td>
					</tr>
					<tr>
						<td valign="middle" class="style7">No. Identitas </td>
						<td valign="middle" class="style7">:</td>
						<td valign="middle" class="style7"><?php echo pelanggan($d->ID_Pelanggan,'kitas'); ?></td>
						<td></td>
					</tr>
					<tr>
						...
						<?php echo strtoupper(pelanggan($d->ID_Pelanggan,'alamat')); ?>
						<?php echo strtoupper(desa(pelanggan($d->ID_Pelanggan,'desa'))); ?>, <?php echo strtoupper(kecamatan(pelanggan($d->ID_Pelanggan,'kecamatan'))); ?>, <?php echo strtoupper(kota(pelanggan($d->ID_Pelanggan,'kota'))); ?>, <?php echo strtoupper(provinsi(pelanggan($d->ID_Pelanggan,'provinsi'))); ?>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td valign="middle" class="style7">:</td>
						<td valign="middle" colspan="2" class="style7"><?php echo strtoupper(ifnull($d->Nm_Usaha,$d->Perihal)); ?></td>
					</tr>
					<tr>
						<td valign="top" class="style7">Alamat Usaha</td>
						<td valign="top" class="style7">:</td>
						<td valign="top" colspan="2" class="style7" align="left" >
						<?php echo strtoupper(ifnull($d->Alamat_Usaha,'')); ?>
						<?php echo strtoupper(desa($d->Kd_Desa)); ?>, <?php echo strtoupper(kecamatan($d->Kd_Kecamatan)); ?>, <?php echo strtoupper(kota($d->Kd_Kota)); ?>, <?php echo strtoupper(provinsi($d->Kd_Provinsi)); ?>
					   </td>
					</tr>
				</table>
				<br/>
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="">
					<tr>
						...
						<td width="40%" align="right" class="style10"><i>User Pendaftar : <?php echo ifnull($d->Nm_FO,'-'); ?></i></td>
					</tr>
				</table>
			</td>
		</tr>
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="">
					<tr>
						...
						<td width="500" rowspan="4" align="right" valign="top" class="style7">
							...
							jQuery('#barcode2').barcode("<?php echo $d->ID_Reg; ?>","code128",settings);
							</script>
						</td>
					</tr>
					...
					<tr>
						<td valign="middle" class="style7">Tempat Bekerja </td>
						<td valign="middle" class="style7">:</td>
						<td valign="middle" colspan="2" class="style7"><?php echo strtoupper(ifnull($d->Nm_Usaha,$d->Perihal)); ?></td>
					</tr>
					<tr>
						<td valign="top" class="style7">Alamat Tempat Bekerja</td>
						<td valign="top" class="style7">:</td>
						<td valign="top" colspan="2" class="style7" align="left" >
						<?php echo strtoupper(ifnull($d->Alamat_Usaha,'')); ?>
					...
					if($data_dok->num_rows() > 0){
						foreach($data_dok->result() as $dok){
							...
							<tr>
								...
								<td valign="top" class="style10">'.($cek? 'ADA' : ($dok->Petugas == 1 ? '<i>(Dilengkapi petugas)</i>' : '-')).'</td>
							</tr>';
						}
					} 
					?>
