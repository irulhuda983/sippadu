				...
				<div class="tile-body">
					...
					<?php echo form_open('',array('class' => 'form-horizontal', 'role' => 'form')); ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10"><input type="text" name="no_agenda" id="no_agenda" placeholder="Nomor Agenda" class="form-control" value="<?php echo html_entity_decode(set_value('',$no_agenda)); ?>" /></div>
							</div>
							<div class="form-group">
