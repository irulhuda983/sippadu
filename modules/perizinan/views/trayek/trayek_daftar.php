...
<html class="no-js" lang="">
    ...
    <body id="minovate" class="appWrapper">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab2">
                                    ...
                                    <div name="step2" class="form-horizontal" role="form">
										...
										<span id="dsp_sebab" style="display:none;">
										<div class="form-group">
											<label for="" class="col-sm-2 control-label">Sebab Penutupan</label>
											<div class="col-sm-6"><input type="text" name="sebab" id="sebab" placeholder="Sebab Penutupan" class="form-control" value="<?php echo set_value('sebab',$sebab); ?>" /></div>
										</div> 
										</span>
										...
										<div class="form-group">
											<label for="" class="col-sm-2 control-label">Nama Apotek</label>
											<div class="col-sm-6"><input type="text" name="nama_usaha" id="nama_usaha" placeholder="Nama Usaha" class="form-control" value="<?php echo set_value('nama_usaha',$nm_usaha); ?>" /></div>
										</div>  
										<div class="form-group">
											<label for="" class="col-sm-2 control-label">Jabatan Pemohon</label>
											<div class="col-sm-6"><input type="text" name="jabatan_pemohon" id="jabatan_pemohon" placeholder="Jabatan Pemohon" class="form-control" value="<?php echo set_value('jabatan_pemohon',$jabatan_pemohon); ?>" /></div>
										</div> 
										<div class="form-group">
											<label for="" class="col-sm-2 control-label">Nama Pemilik Apotek</label>
											<div class="col-sm-6"><input type="text" name="nama_pemilik" id="nama_pemilik" placeholder="Nama Pemilik" class="form-control" value="<?php echo set_value('nama_pemilik',$nama_pemilik); ?>" /></div>
										</div> 
										<div class="form-group">
											<label for="" class="col-sm-2 control-label">Nama Apoteker</label>
											<div class="col-sm-6"><input type="text" name="nama_apoteker" id="nama_apoteker" placeholder="Nama Apoteker" class="form-control" value="<?php echo set_value('nama_apoteker',$nama_apoteker); ?>" /></div>
										</div> 
										<div class="form-group">
											<label for="" class="col-sm-2 control-label">Alamat Apotek</label>
											<div class="col-sm-6"><input type="text" name="alamat_usaha" id="alamat_usaha" placeholder="Alamat Usaha" class="form-control" value="<?php echo set_value('alamat_usaha',$alamat_usaha); ?>" /></div>
										</div> 
										
										<div class="form-group" id="">
											<label for="" class="col-sm-2 control-label">Provinsi</label>
										   <div class="col-sm-6"><span id="dsp_provinsi"><?php echo form_dropdown('op_provinsi',op_provinsi(),set_value('op_provinsi',$slc_provinsi),'id="op_provinsi" class="form-control"'); ?></span></div>
										</div> 

										<div class="form-group" id="">
											<label for="" class="col-sm-2 control-label">Kota</label>
										   <div class="col-sm-6"><span id="dsp_kota"><?php echo form_dropdown('op_kota',op_kota($slc_provinsi),set_value('op_kota',$slc_kota),'id="op_kota" class="form-control"'); ?></span></div>
										</div> 

										<div class="form-group" id="">
											<label for="" class="col-sm-2 control-label">Kecamatan</label>
										   <div class="col-sm-6"><span id="dsp_kecamatan"><?php echo form_dropdown('op_kecamatan',op_kecamatan($slc_kota),set_value('op_kecamatan',$slc_kecamatan),'id="op_kecamatan" class="form-control"'); ?></span></div>
										</div> 

										<div class="form-group" id="">
											<label for="" class="col-sm-2 control-label">Desa</label>
										   <div class="col-sm-6"><span id="dsp_desa"><?php echo form_dropdown('op_desa',op_desa(),set_value('op_desa',$slc_desa),'id="op_desa" class="form-control"'); ?></span></div>
										</div>
		...
		<script type="text/javascript">
			...
			$("#op_pengurus_permohonan").val("1").trigger("change");
