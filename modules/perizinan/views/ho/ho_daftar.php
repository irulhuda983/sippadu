                                ...
                                <div class="tab-pane" id="tab2">
                                    ...
                                    <div name="step2" class="form-horizontal" role="form">
										...
										<div class="form-group">
										   ...
										   <div class="col-sm-6"><textarea type="text" name="alamat_usaha" id="alamat_usaha" placeholder="Alamat Usaha" class="form-control upper" ><?php echo set_value('alamat_usaha'); ?></textarea></div>
										</div> 
										<div class="form-group" id="">
											<label for="" class="col-sm-2 control-label">Provinsi</label>
