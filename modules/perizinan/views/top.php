                ...
                <header class="clearfix">
                   <div class="branding">
                    ...
                    <ul class="nav-right pull-right list-inline">
                        ...
                        <li class="dropdown nav-profile" style="padding-right: 10px;">
                            <a href class="dropdown-toggle" data-toggle="dropdown">
                                <?php echo lang('Hai').', '.($userfullname != '' ? $userfullname.' <i class="fa fa-angle-down"></i>' : lang('Pengunjung') ); ?>  
                            </a>
                            ...
                            <ul class="dropdown-menu animated littleFadeInDown" role="menu">
								 ...
								 <li>
                                    <a role="button" tabindex="0" href="<?php echo apps_url(4,'akun'); ?>" ><div class="pic-circle"><?php echo picprof($this->session->userdata('userid'),'class=""'); ?></div></a>
                                </li>
                                <li>
                                    <a role="button" tabindex="0" href="<?php echo apps_url(4,'akun'); ?>">
                                        <i class="fa fa-user"></i>Profil
                                    </a>
                                </li>
                                <li>
                                    <a role="button" tabindex="0" href="<?php echo apps_url(4,'akun/password'); ?>">
