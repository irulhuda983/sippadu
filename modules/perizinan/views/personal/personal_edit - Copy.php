...
<html class="no-js" lang="">
    ...
    <body id="minovate" class="appWrapper">
									...
									<div class="tab-content">
										...
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><?php echo form_dropdown('op_pelanggan',$op_pelanggan,set_value('op_pelanggan'),'id="op_pelanggan" class="form-control" style="width:100%;"'); ?></div>
											</div> 
											
											<span id="dsp_pelanggan">
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">No Identitas</label>
												<div class="col-sm-6"><input type="text" name="nokitas" id="nokitas" placeholder="No Identitas (KTP, Passpor, dll)" class="form-control" value="<?php echo set_value('nokitas',$no_kitas); ?>" readonly /></div>
											</div> 
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="email" id="email" placeholder="Email" class="form-control" value="<?php echo set_value('email',$email); ?>" readonly /></div>
											</div> 
											</span>
		...
		<script type="text/javascript">
			...
			$("#op_pelanggan").val("<?php echo $id; ?>").trigger("change");
		</script>
    </body>
</html>
