									...
									<?php echo form_open_multipart('',array('class' => 'form-horizontal', 'role' => 'form')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="nokitas" class="form-control" placeholder="Nomor Identitas" value="<?php echo set_value('nokitas'); ?>" /></div>
											</div>                         

											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Nama Lengkap</label>
											   <div class="col-sm-6"><input type="text" name="nama" class="form-control" placeholder="Nama Lengkap" value="<?php echo set_value('nama'); ?>"/></div>
											</div> 
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="no_hp" id="no_hp" placeholder="Nomor Handphone" class="form-control" value="<?php echo set_value('no_hp'); ?>" /></div>
											</div>
