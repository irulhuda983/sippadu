														...
														if($data->num_rows() > 0){
															foreach($data->result() as $d){
																...
																<tr>                                    
																	...
																	<td>'.$d->No_HP.'</td>
																	<td>'.anchor_popup_label(base_url('assets/'.config('theme').'/files/berkas/personal/'.$d->Filename),'Dokumen','info',$popup).'</td> 
																	<td align="center">'.anchor_label(site_url(fmodule('personal/klaim_edit/'.$d->ID)),'Ubah','success').'</td>
																</tr>  '; 
															}
														}
													?>
