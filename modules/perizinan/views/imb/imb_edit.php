    ...
    <body id="minovate" class="appWrapper">
                                ...
                                <div class="tile-body">
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group" id="">
												<label for="" class="col-sm-2 control-label">Jenis Izin</label>
											   <div class="col-sm-6"><?php echo form_dropdown('op_kategori_imb',$op_kategori_imb,set_value('op_kategori_imb',$d2->Jenis_Bangunan),'id="op_kategori_imb" class="form-control chosen-select"'); ?></div>
											</div> 
											
											<div class="form-group" id="">
												<label for="" class="col-sm-2 control-label">Peruntukan Bangunan</label>
											   <div class="col-sm-6"><?php echo form_dropdown('op_peruntukan_imb',$op_peruntukan_imb,set_value('op_peruntukan_imb',$d2->Peruntukan_Bangunan),'id="op_peruntukan_imb" class="form-control chosen-select"'); ?></div>
											</div> 
											<div class="form-group">
		...
		<script type="text/javascript">
			...
			$("#op_perusahaan").change(function(){
				$.ajax({
						type: "POST",
						url : "<?php echo site_url(fmodule('imb/op_perusahaan')); ?>/?time=" + new Date().getTime(),
