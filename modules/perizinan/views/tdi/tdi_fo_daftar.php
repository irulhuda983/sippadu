    ...
    <body id="minovate" class="appWrapper">
									...
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="alamat_usaha" id="alaat_usaha" placeholder="Alamat Usaha" class="form-control" value="<?php echo set_value('alamat_usaha'); ?>" /></div>
											</div> 					
											<div class="form-group" id="">
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="telp_usaha" id="telp_usaha" placeholder="Nomor Telepon" class="form-control" value="<?php echo set_value('telp_usaha'); ?>" /></div>
											</div> 											
		...
		<script type="text/javascript">
			...
			$("#op_perusahaan").change(function(){
				$.ajax({
						type: "POST",
						url : "<?php echo site_url(fmodule('tdi/op_perusahaan')); ?>/?time=" + new Date().getTime(),
