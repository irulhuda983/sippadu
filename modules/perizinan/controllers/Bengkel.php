...
class Bengkel extends CI_Controller {
	...
	public function index()
	{
		...
		if($this->input->post('submit')){
			$this->mod_bengkel->insert_bengkel();
		}
		...
		$d['op_perusahaan'] = $this->mod_bengkel->op_perusahaan($user);
		$d['op_bentuk_perusahaan'] = $this->mod_bengkel->op_bentuk_perusahaan();
		$d['op_pelanggan'] = $this->mod_bengkel->op_pelanggan($user);
		$d['data'] = $this->mod_bengkel->get_personal($user);
		$d['Kd_Izin'] = $this->kode_izin;
		$d['Class_Izin'] = $this->class_izin;
		$d['Kd_Jenis'] = $Kd_Jenis;
		$d['Syarat_Ketentuan'] = $this->mod_bengkel->syarat_ketentuan($this->kode_izin);
	...
	public function op_perusahaan(){
		...
		$d['op_bentuk_perusahaan'] = $this->mod_bengkel->op_bentuk_perusahaan();
		$d['data'] = $this->mod_bengkel->get_perusahaan($idperusahaan);
