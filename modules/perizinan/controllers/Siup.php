...
class Siup extends CI_Controller {
	...
	public function index()
	{
		...
		$d['op_perusahaan'] = $this->mod_siup->op_perusahaan($user);
		$d['op_bentuk_perusahaan'] = $this->mod_siup->op_bentuk_perusahaan();
		$d['op_pelanggan'] = $this->mod_siup->op_pelanggan($user);
		$d['data'] = $this->mod_siup->get_personal($user);
		$d['Kd_Izin'] = $this->kode_izin;
		$d['Class_Izin'] = $this->class_izin;
		$d['Kd_Jenis'] = $Kd_Jenis;
		$d['Syarat_Ketentuan'] = $this->mod_siup->syarat_ketentuan($this->kode_izin);
	...
	public function op_perusahaan(){
		...
		$d['op_bentuk_perusahaan'] = $this->mod_siup->op_bentuk_perusahaan();
		$d['data'] = $this->mod_siup->get_perusahaan($idperusahaan);
