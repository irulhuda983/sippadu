									...
									<?php echo form_open('',array('class' => 'form-horizontal', 'role' => 'form')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-10"><?php echo form_input('Nm_Album',set_value('Nm_Album',$d->Nm_Album),'class="form-control"'); ?></div>
											</div>                         
											...
											<div class="form-group">
												...
												<div class="col-sm-5"><?php echo form_multiselect('op_gallery_kategori[]',$op_gallery_kategori,set_value('op_gallery_kategori[]',$slc_op_gallery_kategori),'class="form-control chosen-select"'); ?></div>
											</div> 
