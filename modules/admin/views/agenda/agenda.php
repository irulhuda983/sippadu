													...
													<?php
														if($data->num_rows() > 0){
															foreach($data->result() as $d){
																echo '
																<tr>                                    
																	<td class="center"><label class="checkbox checkbox-custom-alt checkbox-custom-sm m-0">'.form_checkbox('chk[]',$d->ID_Agenda).'<i></i></label></td>
																	<td>'.$d->Judul.'</td>
																	<td>'.agenda_kategori($d->ID_Agenda).'</td>
																	<td>'.$d->Nm_User.'</td>
																	<td>'.$d->Time_Mulai.'</td> 
																	<td>'.$d->Time_Akhir.'</td> 
																	<td>'.$d->Lokasi.'</td> 
																	...
																	<td align="center">'.icon_edit(site_url(fmodule($class_page.'/edit/'.$d->ID_Agenda))).'</td>	
																</tr>  '; 
															}
														}
													?>
