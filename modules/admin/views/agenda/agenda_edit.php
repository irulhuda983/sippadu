										...
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="input-group datetimepicker">
                                                    <input type="text" name="Time_Mulai" class="form-control" value="<?php echo set_value('Time_Mulai',TimeFormat($d->Time_Mulai,'d/m/Y H:i')); ?>" />
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
												<div class="input-group datetimepicker">
                                                    <input type="text" name="Time_Akhir" class="form-control" value="<?php echo set_value('Time_Akhir',TimeFormat($d->Time_Akhir,'d/m/Y H:i')); ?>" />
                                                    <span class="input-group-addon">
                                                        <span class="fa fa-calendar"></span>
                                                    </span>
                                                </div>
											...
											<div class="form-group">
												...
												<div class="col-sm-2">
													<label class="checkbox checkbox-custom-alt checkbox-custom-sm m-0"><?php echo form_checkbox('Tampilkan_Jam',1,( $d->Tampilkan_Jam ? TRUE : FALSE)); ?><i></i> Ya</label>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-2">
													<label class="checkbox checkbox-custom-alt checkbox-custom-sm m-0"><?php echo form_checkbox('All_Day',1,( $d->All_Day ? TRUE : FALSE)); ?><i></i> Ya</label>
												</div>
											</div>
											
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Lokasi</label>
												<div class="col-sm-10"><?php echo form_input('Lokasi',set_value('Lokasi',$d->Lokasi),'class="form-control"'); ?></div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-5">
													<?php echo imgsrc($d->Image_Raw.'_thumb'.$d->Image_Ext,'agenda',config('main_site')); ?>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-5"><?php echo form_multiselect('op_agenda_kategori[]',$op_agenda_kategori,set_value('op_agenda_kategori[]',$slc_op_agenda_kategori),'class="form-control chosen-select"'); ?></div>
											</div> 
