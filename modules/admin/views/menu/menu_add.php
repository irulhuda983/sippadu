...
<html class="no-js" lang="">
    ...
    <body id="minovate" class="appWrapper">
									...
									<?php echo form_open_multipart('',array('class' => 'form-horizontal', 'role' => 'form')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-5"><?php echo level_menu_dropdown('op_parent',0,'id="op_parent" class="form-control chosen-select"',0,0); ?></div>
											</div> 
											</span>
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><?php echo form_input('Class_Menu',set_value('Class_Menu'),'id="Class_Menu" class="form-control" placeholder="(Opsional)"'); ?></div>
											</div>  
											
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Jenis Menu</label>
												<div class="col-sm-2"><label class="checkbox checkbox-custom-alt"><?php echo form_radio('Jn_Menu',1,(set_value('Jn_Menu',1)==1 ? TRUE : FALSE),'class="Jn_Menu"'); ?><i></i> Konten </label></div>
												<div class="col-sm-2"><label class="checkbox checkbox-custom-alt"><?php echo form_radio('Jn_Menu',2,(set_value('Jn_Menu')==2 ? TRUE : FALSE),'class="Jn_Menu"'); ?><i></i> Item / Link </label> </div>
												<div class="col-sm-2"><label class="checkbox checkbox-custom-alt"><?php echo form_radio('Jn_Menu',3,(set_value('Jn_Menu')==3 ? TRUE : FALSE),'class="Jn_Menu"'); ?><i></i> Frame </label> </div>
											</div>   
											
											<div id="div_url" class="form-group" style="display:none;">
												<label for="" class="col-sm-2 control-label">Apps / URL</label>
												<div class="col-sm-2"><?php echo form_dropdown('op_apps',$op_apps_active,set_value('op_apps'),'id="op_apps" class="form-control chosen-select"'); ?></div>
												<span id="url_external">
												<div class="col-sm-6"><?php echo form_input('URL',set_value('URL'),'id="url" class="form-control" placeholder="http://"'); ?></div>
												</span>
												<span id="url_item">
											...
											<div id="div_jenis_item" class="form-group" style="display:none;">
												...
												<div class="col-sm-2" style="display:none;"><?php echo form_input('ID_Config',set_value('ID_Config'),'id="ID_Config" class="form-control" placeholder="- Belum dipilih -" readonly'); ?></div>
												<div class="col-sm-9"><?php echo form_input('Jn_Item',set_value('Jn_Item'),'id="Jn_Item" class="form-control" placeholder="- Belum dipilih -" readonly'); ?></div>
											</div>

											<div id="div_nama_item" class="form-group" style="display:none;">
												<label for="" class="col-sm-2 control-label">Nama Item</label>
												<div class="col-sm-2" style="display:none;"><?php echo form_input('Item',set_value('Item'),'id="Item" class="form-control" placeholder="- Belum dipilih -" readonly'); ?></div>
												<div class="col-sm-9"><?php echo form_input('Nm_Item',set_value('Nm_Item'),'id="Nm_Item" class="form-control" placeholder="- Belum dipilih -" readonly'); ?></div>
											</div>								
											
											<div id="div_fr_judul" class="form-group" style="display:none">
											...
											<div id="div_fr_width" class="form-group" style="display:none">
											...
											<div id="div_fr_height" class="form-group" style="display:none">
											...
											<!--<div class="form-group">
											   ...
											   <div class="col-sm-9"><textarea name="Deskripsi1" class="summernote"></textarea></div>
											</div>
											
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Deskripsi 2</label>
											   <div class="col-sm-9"><textarea name="Deskripsi2" class="summernote"></textarea></div>
											</div>-->
		...
		$("#op_menu_kategori").val("<?php echo set_value('op_apps',$slc_op_menu_kategori); ?>").trigger("change");
		$("#op_apps").val("<?php echo set_value('op_apps',0); ?>").trigger("change");
		</script>
