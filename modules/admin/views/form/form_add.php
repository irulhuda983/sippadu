...
<html class="no-js" lang="">
    ...
    <body id="minovate" class="appWrapper">
									...
									<?php echo form_open_multipart('',array('class' => 'form-horizontal', 'role' => 'form')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-10"><?php echo form_input('Nm_Form',set_value('Nm_Form'),'class="form-control"'); ?></div>
											</div>  
											...
											<!--<div class="form-group">
												<label for="" class="col-sm-2 control-label">Kolom Form</label>
											...
											<div class="form-group">
												...
												<div class="col-sm-5"><?php echo form_multiselect('op_form_kategori[]',$op_form_kategori,set_value('op_form_kategori[]'),'class="form-control chosen-select"'); ?></div>
											</div> 
		...
		function setting(e){
			...
			myWindow=window.open("<?php echo site_url(fmodule($class_page.'/setting_add/')); ?>" + id + '/' + e,",","menubar=1,resizable=1,width=800,height=700,status=1,screenx=0,screeny=0,scrollbars=1");
		}
