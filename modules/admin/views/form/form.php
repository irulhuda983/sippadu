													...
													<?php
														if($data->num_rows() > 0){
															foreach($data->result() as $d){
																echo '
																<tr>                                    
																	<td class="center"><label class="checkbox checkbox-custom-alt checkbox-custom-sm m-0">'.form_checkbox('chk[]',$d->ID_Form).'<i></i></label></td>
																	<td>'.anchor(fmodule($class_page.'/data/'.$d->ID_Form),$d->Nm_Form).'</td>
																	...
																	<td align="center">'.icon_edit(site_url(fmodule($class_page.'/edit/'.$d->ID_Form))).'</td>	
																</tr>  '; 
															}
														}
													?>
