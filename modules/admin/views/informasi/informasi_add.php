									...
									<?php echo form_open_multipart('',array('class' => 'form-horizontal', 'role' => 'form')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-5"><?php echo form_multiselect('op_informasi_kategori[]',$op_informasi_kategori,set_value('op_informasi_kategori[]'),'class="form-control chosen-select"'); ?></div>
											</div> 
