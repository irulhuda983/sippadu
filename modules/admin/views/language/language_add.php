									...
									<?php echo form_open_multipart('',array('class' => 'form-horizontal', 'role' => 'form')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-10"><?php echo form_input('Nm_Lang',set_value('Nm_Lang'),'class="form-control"'); ?></div>
											</div>  
											
											<div class="form-group">
												<label for="" class="col-sm-2 control-label"><?php echo lang('Class_Language'); ?></label>
												<div class="col-sm-10"><?php echo form_input('Class_Lang',set_value('Class_Lang'),'class="form-control"'); ?></div>
											</div>  
											
											<div class="form-group">
												<label for="" class="col-sm-2 control-label"><?php echo lang('Kode'); ?></label>
												<div class="col-sm-10"><?php echo form_input('Kd_Lang',set_value('Kd_Lang'),'class="form-control"'); ?></div>
											</div>  
