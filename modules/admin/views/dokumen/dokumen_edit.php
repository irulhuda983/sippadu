									...
									<?php echo form_open_multipart('',array('class' => 'form-horizontal', 'role' => 'form')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<?php echo anchor_popup(site_url('dokumen/view/'.$ID_Dokumen),'Preview',$popup); ?>&nbsp;|&nbsp;
												<?php echo anchor(site_url('dokumen/download/'.$ID_Dokumen),'Download'); ?>
												</label>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-5"><?php echo form_multiselect('op_dokumen_kategori[]',$op_dokumen_kategori,set_value('op_dokumen_kategori[]',$slc_op_dokumen_kategori),'class="form-control chosen-select"'); ?></div>
											</div> 
