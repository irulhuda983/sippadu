								...
								<?php echo form_open('',array('name' => 'form', 'id' => 'form')); ?>
									<div class="tile-widget">
										...
										<div class="row">
											...
											<div class="col-sm-8">
												<input class="btn btn-blue" type="button" id="add" value="Tambah Data" onclick="window.location.href='<?php echo site_url(fmodule('grafik/data_add/'.$id)); ?>'"/>
														...
														if($data->num_rows() > 0){
															foreach($data->result() as $d){
																...
																<tr>                                    
																	...
																	<td>'.form_input('Sort_Order[]',set_value('Sort_Order[]',$d->Sort_Order),'style="width:50px;text-align:right;"').form_hidden('ID[]',$d->ID).'</td>
																	<td align="center">'.icon_status($d->Status).'</td>
																	<td align="center">'.icon_edit(site_url(fmodule('grafik/data_edit/'.$d->ID_Grafik.'/'.$d->ID))).'</td>	
																</tr>  '; 
															}
														}
													?>
