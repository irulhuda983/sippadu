									...
									<?php echo form_open_multipart('',array('class' => 'form-horizontal', 'role' => 'form')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-10"><?php echo form_input('Nama',set_value('Nama'),'class="form-control"'); ?></div>
											</div>
											

											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Tempat Lahir</label>
												<div class="col-sm-10"><?php echo form_input('Tempat_Lahir',set_value('Tempat_Lahir'),'class="form-control"'); ?></div>
											</div>				
											...
											<div class="form-group">
												...
												<div class="input-group datepicker">
                                                    <input type="text" name="Tgl_Lahir" class="form-control" value="<?php echo set_value('Tgl_Lahir',TimeNow('d/m/Y')); ?>" />
											...
											<div class="form-group">
												...
												<div class="col-sm-10"><?php echo form_input('Alamat',set_value('Alamat'),'class="form-control"'); ?></div>
											</div>
											
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Telepon</label>
												<div class="col-sm-10"><?php echo form_input('Telepon',set_value('Telepon'),'class="form-control"'); ?></div>
											</div>	
											...
											<div class="form-group">
												...
												<div class="col-sm-10"><?php echo form_input('Website',set_value('Website'),'class="form-control"'); ?></div>
											</div>

											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Jabatan</label>
												<div class="col-sm-10"><?php echo form_input('Jabatan',set_value('Nama'),'class="form-control"'); ?></div>
											</div>
											
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Keterangan</label>
											   <div class="col-sm-10"><textarea name="Keterangan" id="summernote"></textarea></div>
											</div> 
											...
											<div class="form-group">
												...
												<div class="col-sm-5"><?php echo form_multiselect('op_anggota_kategori[]',$op_anggota_kategori,set_value('op_anggota_kategori[]'),'class="form-control chosen-select"'); ?></div>
											</div> 
