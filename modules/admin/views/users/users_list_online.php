			...
			echo '
				<li class="online">
					<div class="media" style="cursor: help;" >
						<a class="pull-left avatar-circle" role="button" tabindex="0" href="javascript:void(0)" style="cursor: help;">
							'.avatar($d->ID_User,'class=""').'
						</a>
			...
			if($d->Status == 1){
				...
				<li class="online">
					<div class="media" style="cursor: pointer; cursor: hand;" onClick="javascript:chatWith(\''.$d->Username.'\')">
						<a class="pull-left avatar-circle" role="button" tabindex="0" href="javascript:void(0)">
							'.avatar($d->ID_User,'class=""').'
						</a>
						<div class="media-body" style="padding-left:10px">
							<span class="media-heading" style="font-weight:bold;">'.$d->Username.'</span>
