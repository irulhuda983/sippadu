													...
													<?php
														if($data_modul->num_rows() > 0){
															foreach($data_modul->result() as $dm){
																echo '
																<tr>                                    
																	<td class="center"><label class="checkbox checkbox-custom-alt checkbox-custom-sm m-0">'.form_checkbox('modul[]',$dm->Kd_Modul,(cek_modul_akses($slc_op_users,$dm->Kd_Modul) ? TRUE : FALSE)).'<i></i></label></td>
																	<td>'.$dm->Nm_Modul.'</td>	
																	<td>'.$dm->Nm_Group.'</td>	
																	<td>'.$dm->Nm_Apps.'</td>	
																</tr>  '; 
