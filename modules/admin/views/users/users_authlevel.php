									...
									<div class="tile-body">
										...
										<div class="block-fluid">  
											<div class="form-group">
												<div class="col-sm-4"><?php echo form_dropdown('op_level',$op_level,set_value('op_level',$slc_op_level),'class="chosen-select form-control" style="width:100%"'); ?></div>
													...
													<?php
														if($data_modul->num_rows() > 0){
															foreach($data_modul->result() as $dm){
																echo '
																<tr>                                    
																	<td class="center"><label class="checkbox checkbox-custom-alt checkbox-custom-sm m-0">'.form_checkbox('modul[]',$dm->Kd_Modul,(level_modul_akses($slc_op_level,$dm->Kd_Modul) ? TRUE : FALSE)).'<i></i></label></td>
																	<td>'.$dm->Nm_Modul.'</td>	
																	<td>'.$dm->Nm_Group.'</td>	
																	<td>'.$dm->Nm_Apps.'</td>	
																</tr>  '; 
