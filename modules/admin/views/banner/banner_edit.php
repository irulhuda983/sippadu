									...
									<?php echo form_open_multipart('',array('class' => 'form-horizontal', 'role' => 'form')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-5">
													<?php echo imgsrc($d->Image_Raw.'_thumb'.$d->Image_Ext,'banner',config('main_site')); ?>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10"><?php echo form_input('Keterangan',set_value('Keterangan',$d->Keterangan),'class="form-control" placeholder="Official Sponsor"'); ?></div>
											</div>
  
											
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">URL</label>
												<div class="col-sm-10"><?php echo form_input('URL',set_value('URL',$d->URL),'class="form-control" placeholder="http://www.domain.com/?p=hsdfgh"'); ?></div>
											</div>
											
											
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Kategori</label>
												<div class="col-sm-5"><?php echo form_multiselect('op_banner_kategori[]',$op_banner_kategori,set_value('op_banner_kategori[]',$slc_op_banner_kategori),'class="form-control chosen-select"'); ?></div>
											</div> 
