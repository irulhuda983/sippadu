									...
									<?php echo form_open_multipart('',array('class' => 'form-horizontal', 'role' => 'form')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-5"><?php echo form_multiselect('op_download_kategori[]',$op_download_kategori,set_value('op_download_kategori[]'),'class="form-control chosen-select"'); ?></div>
											</div> 
