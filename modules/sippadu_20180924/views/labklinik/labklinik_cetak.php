								...
								<?php echo form_open('',array('name' => 'form', 'id' => 'form')); ?>
									<div class="tile-widget">
										...
										<div class="row">
											...
											<div class="col-sm-8">
												<input class="btn btn-greensea" type="button" name="button" value="Antrian" onclick="window.location.href='<?php echo site_url(fmodule('labklinik/cetak')); ?>'"/>
												<input class="btn btn-dutch" type="button" name="button" value="Arsip" onclick="window.location.href='<?php echo site_url(fmodule('labklinik/cetak_all')); ?>'"/>
											</div>
