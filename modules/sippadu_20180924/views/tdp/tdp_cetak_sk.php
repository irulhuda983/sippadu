	...
	<?php } ?>
		...
		<table width="1100" border="0" align="center" cellpadding="8" cellspacing="0">
		  ...
		  <tr>
			...
			<?php echo strtoupper(desa(perusahaan($d->IDPERUSAHAAN,'desa'))); ?>, <?php echo strtoupper(kecamatan(perusahaan($d->IDPERUSAHAAN,'kecamatan'))); ?>, <?php echo strtoupper(kota(perusahaan($d->IDPERUSAHAAN,'kota'))); ?>, <?php echo strtoupper(provinsi(perusahaan($d->IDPERUSAHAAN,'provinsi'))); ?></td>
          </tr>
		  <tr>
		...
		<?php } 
		elseif($bntk_perusahaan == '5'){ ?>
		<table width="1100" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
            <td colspan="6" height="45" valign="middle" class="atv_teks1" style="border-left:1px solid #000000; border-right:1px solid #000000; "><u>PENGESAHAN MENTERI KOPERASI : </u></td>
          </tr>
		  <tr height="20" valign="middle">
			<td width="100px" class="atv_teks1" style="border-left:1px solid #000000; border-bottom:1px solid #000000">NOMOR</td>
			<td class="atv_teks1" style="border-bottom:1px solid #000000">:</td>
		   ...
		   <tr>
            <td colspan="6" height="45" valign="middle" class="atv_teks1" style="border-left:1px solid #000000; border-right:1px solid #000000; "><u>PERUBAHAN ANGGARAN DASAR : </u></td>
          </tr>
		  <tr height="20" valign="middle">
			<td class="atv_teks1" style="border-left:1px solid #000000; border-bottom:1px solid #000000">NOMOR</td>
			<td class="atv_teks1" style="border-bottom:1px solid #000000">:</td>
		...
		<table width="1100" border="0" align="center" cellpadding="10" cellspacing="0" style="font-size:12px;">
			...
			<tr>
				...
				<td width="410" colspan="1" align="center" valign="top" class="atv_teks1">
					<b><?php echo sippadu('nama_jabatan'); ?><br/><?php echo strtoupper(sippadu('nama_kota2')); ?></b><br>
					<div style="width:320px;height:135px;"><?php echo imgttd($d->FLOWB); ?></div>
