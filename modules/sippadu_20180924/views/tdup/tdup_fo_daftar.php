									...
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="nama_usaha" id="nama_usaha" placeholder="PT. ABC / CV. ABC" class="form-control" value="<?php echo set_value('nama_usaha'); ?>" /></div>
											</div> 
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="alamat_usaha" id="alamat_usaha" placeholder="Jl. Ahmad Yani No.1 RT.01 RW.01" class="form-control" value="<?php echo set_value('alamat_usaha'); ?>" /></div>
											</div> 
