								...
								<?php echo form_hidden('Kd_Verifikasi',$Kd_Verifikasi); ?>
									<div class="tile-widget">
										...
										<div class="row">
											...
											<div class="col-sm-8">
												<input class="btn btn-greensea" type="button" name="add" value="Antrian" onclick="window.location.href='<?php echo site_url(fmodule('imb/bo')); ?>'"/>
												<input class="btn btn-dutch" type="button" name="add" value="Arsip" onclick="window.location.href='<?php echo site_url(fmodule('imb/bo_all')); ?>'"/>
