								...
								<?php echo form_open('',array('name' => 'form', 'id' => 'form')); ?>
									<div class="tile-widget">
										...
										<div class="row">
											...
											<div class="col-sm-8">
												<input class="btn btn-blue" type="button" name="add" value="Tambah Data" onclick="window.location.href='<?php echo site_url(fmodule('dokumen/master_jenis_add')); ?>'"/>
													...
													<?php
														if($data->num_rows() > 0){
															foreach($data->result() as $d){
																echo '
																<tr>                                    
																	<td class="center"><label class="checkbox checkbox-custom-alt checkbox-custom-sm m-0">'.form_checkbox('chk[]',$d->Kd_Dok).'<i></i></label></td>
																	<td>'.$d->Nm_Dok.'</td>
																	<td align="center">'.anchor_label(site_url(fmodule('dokumen/master_jenis_edit/'.$d->Kd_Dok)),'Ubah','success').'</td>	
																</tr>  '; 
															}
														}
													?>
