								...
								<?php echo form_hidden('Kd_Verifikasi',$Kd_Verifikasi); ?>
									<div class="tile-widget">
										...
										<div class="row">
											...
											<div class="col-sm-8">
												<input class="btn btn-greensea" type="button" name="add" value="Antrian" onclick="window.location.href='<?php echo site_url(fmodule('apotek/tu')); ?>'"/>
												<input class="btn btn-dutch" type="button" name="add" value="Arsip" onclick="window.location.href='<?php echo site_url(fmodule('apotek/tu_all')); ?>'"/>
											</div>
														...
														if($data->num_rows() > 0){
															...
															foreach($data->result() as $d){
																...
																<tr>            
																	...
																	<td align="center">'.anchor_label(site_url(fmodule('apotek/tu_edit/'.$d->ID)),'Verifikasi','success').'</td>
																</tr>  ';
																++$n;
															}
														}
