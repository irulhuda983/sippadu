										...
										<div class="row">
											...
											<div class="col-sm-8">
												<div class="btn-group mb-10">
													<input class="btn btn-blue" type="submit" name="verifikasi" value="Verifikasi yang Dipilih"/>
													<input class="btn btn-cyan" type="button" name="add" value="Refresh" onclick="window.location.href='<?php echo current_url(); ?>'"/>
													<input class="btn btn-greensea" type="button" name="add" value="Izin Belum Diproses" onclick="window.location.href='<?php echo site_url(fmodule('siup/kabid')); ?>'"/>
													<input class="btn btn-dutch" type="button" name="add" value="Izin Telah Diproses" onclick="window.location.href='<?php echo site_url(fmodule('siup/kabid_all')); ?>'"/>
												</div>
											</div>
														...
														if($data->num_rows() > 0){
															foreach($data->result() as $d){
																...
																<tr>   
																	...
																	<td align="center">'.anchor_popup_label(site_url(fmodule('siup/sk/'.$d->ID)),'Preview','info',$popup).'</td>		
																</tr>  ';
															}
														}
													?>
