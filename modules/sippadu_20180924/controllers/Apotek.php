...
class Apotek extends CI_Controller {
	...
	public function fo_edit($idapotek=0)
	{
		...
		$idperusahaan = 0;
		$Kd_Pengurus = 0;
		$data = $this->mod_apotek->get_apotek($idapotek);
		if($data->num_rows() > 0){
			$aa = $data->row();
		...
		if($this->input->post('submit')){
			$this->mod_apotek->update_apotek($idapotek);
		}
		...
		$d['op_bentuk_perusahaan'] = $this->mod_apotek->op_bentuk_perusahaan();
		$d['data'] = $this->mod_apotek->get_personal($idpelanggan);
		$d['data2'] = $this->mod_apotek->get_data_apotek($idapotek);
		$d['Kd_Pelanggan'] = $idpelanggan;
		$d['Kd_Perusahaan'] = $idperusahaan;
		$d['Kd_Jenis'] = $jenis_izin;
	...
	public function bo_edit($idapotek=0)
	{
	...
	public function tu_edit($idapotek=0)
	{
