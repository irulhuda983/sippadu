...
class Opklinik extends CI_Controller {
	...
	public function fo_edit($idopklinik=0)
	{
		...
		$idperusahaan = 0;
		$Kd_Pengurus = 0;
		$data = $this->mod_opklinik->get_opklinik($idopklinik);
		if($data->num_rows() > 0){
			$aa = $data->row();
		...
		if($this->input->post('submit')){
			$this->mod_opklinik->update_opklinik($idopklinik);
		}
		...
		$d['op_bentuk_perusahaan'] = $this->mod_opklinik->op_bentuk_perusahaan();
		$d['data'] = $this->mod_opklinik->get_personal($idpelanggan);
		$d['data2'] = $this->mod_opklinik->get_data_opklinik($idopklinik);
		$d['Kd_Pelanggan'] = $idpelanggan;
		$d['Kd_Perusahaan'] = $idperusahaan;
		$d['Kd_Jenis'] = $jenis_izin;
		$d['Kd_Pengurus'] = $Kd_Pengurus;
		$d['ID_Izin'] = $idopklinik;
	...
	public function bo_edit($idopklinik=0)
	{
	...
	public function tu_edit($idopklinik=0)
	{
