...
class Labklinik extends CI_Controller {
	...
	public function fo_edit($idlabklinik=0)
	{
		...
		$idperusahaan = 0;
		$Kd_Pengurus = 0;
		$data = $this->mod_labklinik->get_labklinik($idlabklinik);
		if($data->num_rows() > 0){
			$aa = $data->row();
		...
		if($this->input->post('submit')){
			$this->mod_labklinik->update_labklinik($idlabklinik);
		}
		...
		$d['op_bentuk_perusahaan'] = $this->mod_labklinik->op_bentuk_perusahaan();
		$d['data'] = $this->mod_labklinik->get_personal($idpelanggan);
		$d['data2'] = $this->mod_labklinik->get_data_labklinik($idlabklinik);
		$d['Kd_Pelanggan'] = $idpelanggan;
		$d['Kd_Perusahaan'] = $idperusahaan;
		$d['Kd_Jenis'] = $jenis_izin;
		$d['Kd_Pengurus'] = $Kd_Pengurus;
		$d['ID_Izin'] = $idlabklinik;
	...
	public function bo_edit($idlabklinik=0)
	{
	...
	public function tu_edit($idlabklinik=0)
	{
