                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            No. Registrasi : 0022/LAB-KLINIK/2019 | 
								...
								<form action="">
									...
									<div class="tile-body">
                                        ...
                                        <div class="form-group row">
											...
											<div class="col-sm-6">
                                                <textarea name="hal" id="hal" rows="3" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
											...
											<div class="col-sm-5">
                                                <textarea name="kepada" id="kepada" rows="3" class="form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tile-body">
                                        ...
                                        <div class="form-group">
											<label for="jenis_izin" class="control-label">Dokter Penanggung Jawab</label>
                                    ...
                                    <div class="tile-body">
                                        ...
                                        <div class="form-group row">
											...
											<div class="col-sm-6">
                                                <input type="text" name="tembusan" id="tembusan" class="form-control" value="Dr. Tjetjep Sutisna">
                                            </div>
                                        </div> 
                                    </div>
                                    <hr class="line-solid line-full">
