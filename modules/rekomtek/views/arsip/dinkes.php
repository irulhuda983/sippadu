                            ...
                            <section class="tile">
								...
								<form action="">
											...
											<div class="col-sm-9">
												<ul class="nav nav-pills">
													<?php foreach($menuIzin as $i) : ?>
														<li role="presentation" data-id="<?= $i['Kd_Izin']; ?>" data-url="<?= site_url('dinkes/getDataArsip'); ?>" class="btn-menu-arsip"><a href="#"><?= $i['Kd_Class']; ?></a></li>
													<?php endforeach; ?>
												</ul>
											</div>
									...
									<div class="tile-body p-0">
                                        ...
                                        <div class="table-responsive" id="kotak-data-arsip">
