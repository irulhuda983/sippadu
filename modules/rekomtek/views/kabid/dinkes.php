                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
								...
								<form action="">
											...
											<div class="col-sm-9">
												<ul class="nav nav-pills">
													<?php foreach($menuIzin as $i) : ?>
														<li role="presentation" data-id="<?= $i['Kd_Izin']; ?>" data-url="<?= site_url('dinkes/getDataKabid'); ?>" class="btn-menu-kabid"><a href="#"><?= $i['Kd_Class']; ?></a></li>
													<?php endforeach; ?>
												</ul>
											</div>
									...
									<!-- tile body -->
									<div class="tile-body p-0" id="kotak-data-kabid">
