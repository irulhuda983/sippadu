			...
			<div class="wrapper">
				<div class="col-9 col-8-m">
					<div class="articleHeaderContent">
						<h5 class="newsTag"><?php echo berita_kategori($d->ID_Berita,TRUE,'style="color:#9e9e9e;text-decoration:none;font-style:italic;"'); ?></h5>
			...
			<div class="col-9">
				<section class="standardArticle">
					...
					<div data-script="pl_editorial-lists" data-widget="video-list" class="articleImage">
						<?php echo imgsrc($d->Image_Raw.'_original'.$d->Image_Ext,'berita'); ?>
					</div>
				...
				<section class="mainWidget latestFeatures ">
					<header><h3 class="subHeader"><?php echo lang('Berita Lainnya'); ?></h3></header>
					<ul class="block-list-4">
						<?php foreach($data_latest->result() as $dl){ ?>
						<li>
							<a href="<?php echo autolink_berita($dl->ID_Berita); ?>"  class="thumbnail">
								<figure>
									<span class="image thumbCrop-latestnews"><?php echo imgsrc($dl->Image_Raw.'_thumb'.$dl->Image_Ext,'berita'); ?></span>
									<figcaption>
