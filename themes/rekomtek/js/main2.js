...
$(function() {
  ...
  MINOVATE.global = {
    ...
    layout: function() {
      var defaultHeaderScheme = 'scheme-black',
          ...
          defaultColorScheme = 'cyan-scheme-color',
          defaultHeaderPosition = 'header-fixed',
          defaultNavbarPosition = 'aside-fixed',
          defaultRightbarVisibility = 'rightbar-hidden',
          defaultAppClasses = 'scheme-black cyan-scheme-color header-fixed aside-fixed rightbar-hidden';
      ...
      $toggleRightbarEl.on('click', function() {
        if ($body.hasClass('rightbar-hidden')) {
		  ...
		  $('.chatbox').removeClass('chatbox-margin')
        }
      });
  ...
  MINOVATE.extra = {
    ...
    datepicker: function() {
	  ...
	  if ($datetimepickerEl.length > 0) {
        $datetimepickerEl.each(function() {
          var element = $(this);
          var format = element.data('format')
          element.datetimepicker({
  ...
  MINOVATE.documentOnReady = {
    ...
    setSidebar: function() {
      ...
      width = $window.width();
	  /* AKTIFKAN BAGIAN INI UNTUK MENAMPILKAN MODEL MENU SAMPING SECARA LEBAR */
     ...
     /*  if (width < 992) {
	  ...
	  /* AKTIFKAN BAGIAN INI UNTUK MENAMPILKAN MODEL MENU SAMPING SECARA HIDDEN */
	  $app.removeClass('sidebar-xs').addClass('sidebar-xs');
  ...
  $('.footer-login').each(function() {
	  $(this).text("Designed and Programmed by Ozhy © "+copyright_year);
  });
