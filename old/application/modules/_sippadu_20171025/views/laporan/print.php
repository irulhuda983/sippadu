...
<body>		
	...
	<table width="1100" border="0" align="center" cellpadding="0" cellspacing="0" style="">
		...
		<tr>
			<td rowspan="4" width="150px" align="right"><img src="<?php echo base_url(); ?>assets/<?php echo config('theme'); ?>/images/<?php echo sippadu('logo_warna'); ?>" width="60px" /></td>
	...
	<table width="1100" border="1" align="center" cellpadding="0" cellspacing="0" style="">
		...
		<tr class="thead">
			...
			<td width="7%" valign="middle" rowspan="2">Petugas Penerima Berkas</td>
			<td width="5%" valign="middle" rowspan="2">Tgl. Selesai</td>
			<td width="7%" valign="middle" rowspan="2">Nama Penerima</td>
			<td width="5%" valign="middle" rowspan="2">Tgl. Diterima</td>
		</tr>
		<tr class="thead">
			<td>L</td>
			<td>P</td>
