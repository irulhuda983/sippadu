                                ...
                                <div class="tile-body">
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Luas Gedung (M<sup>2</sup>)</label>
												<div class="col-sm-6"><input type="text" name="luas" id="luas" placeholder="Luas Gedung" class="form-control" value="<?php echo set_value('luas',$d2->Luas_Bangunan); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Klasifikasi Gudang</label>
												<div class="col-sm-6"><input type="text" name="klasifikasi" id="klasifikasi" placeholder="Klasifikasi Gudang" class="form-control" value="<?php echo set_value('klasifikasi',$d2->Klasifikasi); ?>" /></div>
											</div> 
											<!--<div class="form-group">
