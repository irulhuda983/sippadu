								...
								<?php echo form_open('',array('name' => 'form', 'id' => 'form')); ?>
									...
									<div class="tile-body p-0">
										...
										<div class="table-responsive">
											<table  class="table table-hover" id="tSortable" style="font-size:10px;font-family:Tahoma;color:black;">
												<thead>
													<tr class="active">     
														<th width="50px">Urusan</th>
														<th width="50px">Bidang</th>
														<th width="50px">Unit</th>
														<th width="50px">Sub</th>
														<th width="50px">Desa</th>
														<th width="">Nama Desa</th>
													</tr>
												</thead>
												<tbody>
													<?php
														if($data->num_rows() > 0){
															foreach($data->result() as $d){
																...
																<tr>
																	...
																	<td>'.$d->Kd_Sub.'</td>
																	<td>'.$d->Kd_Desa.'</td>
																	<td>'.($winpopup ? anchor_popup(fmodule($segment_link.'/'.$d->Kd_Urusan.'/'.$d->Kd_Bidang.'/'.$d->Kd_Unit.'/'.$d->Kd_Sub.'/'.$d->Kd_Desa),$d->Nm_Desa,$popup) : anchor(fmodule($segment_link.'/'.$d->Kd_Urusan.'/'.$d->Kd_Bidang.'/'.$d->Kd_Unit.'/'.$d->Kd_Sub.'/'.$d->Kd_Desa),$d->Nm_Desa)).'</td>
																</tr>  '; 
															}
														}
													?>
