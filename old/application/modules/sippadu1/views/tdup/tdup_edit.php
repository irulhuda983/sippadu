    ...
    <body id="minovate" class="appWrapper">
									...
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="no_sk_lama" id="no_sk_lama" placeholder="No SK Lama" class="form-control" value="<?php echo set_value('no_sk_lama',$d2->No_SKL); ?>" /></div>
											</div> 
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="nama_usaha" id="nama_usaha" placeholder="PT. ABC / CV. ABC" class="form-control" value="<?php echo set_value('nama_usaha',$d2->Nm_Usaha); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Jenis Usaha</label>
												<div class="col-sm-6"><input type="text" name="perihal" id="perihal" placeholder="Catering, Apotek, dll" class="form-control" value="<?php echo set_value('perihal',$d2->Perihal); ?>" /></div>
											</div> 
											<div class="form-group">
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Nomor dan Tgl Akte</label>
												<div class="col-sm-4"><input type="text" name="no_akte" id="no_akte" placeholder="No Akte" class="form-control" value="<?php echo set_value('no_akte',$d2->No_Akte); ?>" /></div>
												<div class="col-sm-2"><div class="input-group datepicker" data-format="DD/MM/YYYY"><?php echo form_input('tgl_akte',set_value('tgl_akte',iftimezero($d2->Tgl_Akte,'','d/m/Y')),'class="form-control" id="mask_date" placeholder="Isikan Tanggal"'); ?>
												<span class="input-group-addon"><span class="fa fa-calendar"></span></span></div></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Nama Ijin Teknis</label>
												<div class="col-sm-6"><input type="text" name="nama_izin_teknis" id="nama_izin_teknis" placeholder="Nama Ijin" class="form-control" value="<?php echo set_value('nama_izin_teknis',$d2->Nm_Izin_Teknis); ?>" /></div>
											</div> 
											
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">No Ijin Teknis</label>
												<div class="col-sm-6"><input type="text" name="no_izin_teknis" id="no_izin_teknis" placeholder="Nomor Ijin Teknis" class="form-control" value="<?php echo set_value('no_izin_teknis',$d2->No_Izin_Teknis); ?>" /></div>
											</div> 
											
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Nomor dan Tgl HO</label>
												<div class="col-sm-4"><input type="text" name="no_ho" id="no_ho" placeholder="No HO" class="form-control" value="<?php echo set_value('no_ho',$d2->No_HO); ?>" /></div>
												<div class="col-sm-2"><div class="input-group datepicker" data-format="DD/MM/YYYY"><?php echo form_input('tgl_ho',set_value('tgl_ho',TimeFormat(iftimezero($d2->Tgl_HO),'d/m/Y')),'class="form-control" id="mask_date" placeholder="Isikan Tanggal"'); ?>
												<span class="input-group-addon"><span class="fa fa-calendar"></span></span></div></div>
											</div> 
											
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Nomor dan Tgl IMB</label>
												<div class="col-sm-4"><input type="text" name="no_imb" id="no_imb" placeholder="No IMB" class="form-control" value="<?php echo set_value('no_imb',$d2->No_IMB); ?>" /></div>
												<div class="col-sm-2"><div class="input-group datepicker" data-format="DD/MM/YYYY"><?php echo form_input('tgl_imb',set_value('tgl_imb',TimeFormat(iftimezero($d2->Tgl_IMB),'d/m/Y')),'class="form-control" id="mask_date" placeholder="Isikan Tanggal"'); ?>
												<span class="input-group-addon"><span class="fa fa-calendar"></span></span></div></div>
											</div> 
											<!--<div class="form-group">
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Dasar Perttdupangan</label>
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Tembusan SK</label>
												<div class="col-sm-10"><textarea name="sk_tembusan" id="summernote"><?php echo set_value('sk_tembusan',ifnull($d2->Tembusan,format_parameter(10,13))); ?></textarea></div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-4"><input type="text" name="no_sk" id="no_sk" placeholder="No SK" class="form-control" value="<?php echo set_value('no_sk',$d2->No_SK); ?>" readonly/></div>
												<div class="col-sm-2"><input type="button" class="btn btn-blue" value="Buat Nomor SK"  onclick="popup_el('<?php echo site_url(fmodule('tdup/get_nomor/'.$ID_Izin)); ?>')"/></div>
											</div> 
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													...
													<input class="btn btn-blue" type="button" name="cetak" value="Cetak Tanda Terima" onclick="popup('<?php echo site_url(fmodule('tdup/tt/'.$ID_Izin)); ?>')"/>
													<?php if($Kd_Access == 'bo') { ?>
													<input class="btn btn-blue" type="button" name="cetak" value="Cetak SK" onclick="popup('<?php echo site_url(fmodule('tdup/sk/'.$ID_Izin)); ?>')"/>
													<?php } ?>
												</div>							
											</div>
											<?php } ?>
		...
		<script type="text/javascript">
			...
			$("#op_perusahaan").change(function(){
				$.ajax({
						type: "POST",
						url : "<?php echo site_url(fmodule('tdup/op_perusahaan')); ?>",
