									...
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="no_sk_lama" id="no_sk_lama" placeholder="No SK Lama" class="form-control" value="<?php echo set_value('no_sk_lama',$d2->NO_REF); ?>" /></div>
											</div> 
											<div class="form-group">
											...
											<span id="dsp_perusahaan">
												...
												<div class="form-group">
													...
													<div class="col-sm-6"><?php echo form_dropdown('op_kategori_siup',$op_kategori_siup,set_value('op_kategori_siup'),'id="el" class="form-control"'); ?></div>
												</div>
												<div class="form-group">
