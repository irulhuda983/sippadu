    ...
    <body id="minovate" class="appWrapper">
									...
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group" id="">
											   ...
											   <div class="col-sm-6"><span id="dsp_provinsi2"><?php echo form_dropdown('op_provinsi2',op_provinsi(),set_value('op_provinsi2',ifnull($d2->Kd_Provinsi_L,35)),'id="op_provinsi2" class="form-control slc"'); ?></span></div>
											</div> 

											<div class="form-group" id="">
												<label for="" class="col-sm-2 control-label">Kota (Sebelumnya)</label>
											   <div class="col-sm-6"><span id="dsp_kota2"><?php echo form_dropdown('op_kota2',op_kota(ifnull($d2->Kd_Provinsi_L,35)),set_value('op_kota2',ifnull($d2->Kd_Kota_L,3522)),'id="op_kota2" class="form-control slc"'); ?></span></div>
											</div> 

											<div class="form-group" id="">
												<label for="" class="col-sm-2 control-label">Kecamatan (Sebelumnya)</label>
											   <div class="col-sm-6"><span id="dsp_kecamatan2"><?php echo form_dropdown('op_kecamatan2',op_kecamatan(ifnull($d2->Kd_Kota_L,3522)),set_value('op_kecamatan2',$d2->Kd_Kecamatan_L),'id="op_kecamatan2" class="form-control slc"'); ?></span></div>
											</div> 

											<div class="form-group" id="">
												<label for="" class="col-sm-2 control-label">Desa (Sebelumnya)</label>
											   <div class="col-sm-6"><span id="dsp_desa2"><?php echo form_dropdown('op_desa2',op_desa($d2->Kd_Kecamatan_L),set_value('op_desa2',$d2->Kd_Desa_L),'id="op_desa2" class="form-control slc"'); ?></span></div>
											</div> 
		...
		<script type="text/javascript">
			...
			$("#op_perusahaan").change(function(){
				$.ajax({
						type: "POST",
						url : "<?php echo site_url(fmodule('ho/op_perusahaan')); ?>",
