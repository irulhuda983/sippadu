									...
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="nama_usaha" id="nama_usaha" placeholder="Nama Tempat Bekerja" class="form-control" value="<?php echo set_value('nama_usaha',$d2->Nm_Usaha); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Alamat</label>
												<div class="col-sm-6"><input type="text" name="alamat_usaha" id="alamat_usaha" placeholder="Alamat Tempat Bekerja" class="form-control" value="<?php echo set_value('alamat_usaha',$d2->Alamat_Usaha); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">No. STR</label>
												<div class="col-sm-6"><input type="text" name="str" id="str" placeholder="Nomor STR" class="form-control" value="<?php echo set_value('str',$d2->STR); ?>" /></div>
											</div> 
											<!--<div class="form-group">
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Dasar Pertitkesehatanangan</label>
											...
											<div class="form-group">
												...
												<div class="col-sm-2"><input type="button" class="btn btn-blue" value="Buat Nomor SK"  onclick="popup_el('<?php echo site_url(fmodule('itkesehatan/get_nomor/'.$ID_Izin)); ?>')"/></div>
											</div> 
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													...
													<input class="btn btn-blue" type="button" name="cetak" value="Cetak Tanda Terima" onclick="popup('<?php echo site_url(fmodule('itkesehatan/tt/'.$ID_Izin)); ?>')"/>
													<?php if($Kd_Access == 'bo') { ?>
													<input class="btn btn-blue" type="button" name="cetak" value="Cetak SK" onclick="popup('<?php echo site_url(fmodule('itkesehatan/sk/'.$ID_Izin)); ?>')"/>
													<?php } ?>
												</div>							
											</div>
											<?php } ?>
