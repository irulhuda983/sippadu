...
if($data->num_rows() > 0){ 
	...
	//$daftar_ulang = $d->Izin Tenaga Kesehatan_DAFTAR_ULANG;
}
...
<span id="dsp_agenda" style="display:none;">
	<div class="form-group">
		...
		<div class="col-sm-2"><input type="button" class="btn btn-blue" value="Buat Nomor Agenda"  onclick="popup('<?php echo site_url(fmodule('itkesehatan/get_agenda/'.$ID_Izin)); ?>')"/></div>
	</div> 
	<div class="form-group">
