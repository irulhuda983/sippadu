    ...
    <body id="minovate" class="appWrapper">
                                ...
                                <div class="tile-body">
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Pemasangan Untuk</label>
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Naskah Reklame</label>
												<div class="col-sm-6"><input type="text" name="naskah" id="naskah" placeholder="Naskah Reklame" class="form-control" value="<?php echo set_value('naskah',$d2->Naskah_Reklame); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Ukuran Reklame</label>
												<div class="col-sm-6"><input type="text" name="ukuran" id="ukuran" placeholder="Ukuran Reklame" class="form-control" value="<?php echo set_value('ukuran',$d2->Ukuran_Reklame); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Pemasangan Awal</label>
												<div class="col-sm-2"><div class="input-group datepicker" data-format="DD/MM/YYYY"><?php echo form_input('pasang_awal',set_value('pasang_awal',TimeFormat(iftimezero($d2->J_Waktu_Awal),'d/m/Y')),'class="form-control" id="mask_date" placeholder="Isikan Tanggal"'); ?>
												<span class="input-group-addon"><span class="fa fa-calendar"></span></span></div></div>
											</div> 
											
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Pemasangan Akhir</label>
												<div class="col-sm-2"><div class="input-group datepicker" data-format="DD/MM/YYYY"><?php echo form_input('pasang_akhir',set_value('pasang_akhir',TimeFormat(iftimezero($d2->J_Waktu_Akhir),'d/m/Y')),'class="form-control" id="mask_date" placeholder="Isikan Tanggal"'); ?>
												<span class="input-group-addon"><span class="fa fa-calendar"></span></span></div></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Lokasi Pemasangan</label>
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Dasar Pertimbangan</label>
											...
											<div class="form-group">
												...
												<div class="col-sm-10"><textarea name="sk_tembusan" id="summernote"><?php echo set_value('sk_tembusan',ifnull($d2->Tembusan,format_parameter(8,13))); ?></textarea></div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-2"><input type="button" class="btn btn-blue" value="Buat Nomor SK"  onclick="popup_el('<?php echo site_url(fmodule('reklame/get_nomor/'.$ID_Izin)); ?>')"/></div>
											</div> 
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													...
													<input class="btn btn-blue" type="button" name="cetak" value="Cetak Tanda Terima" onclick="popup('<?php echo site_url(fmodule('reklame/tt/'.$ID_Izin)); ?>')"/>
													<?php if($Kd_Access == 'bo') { ?>
													<input class="btn btn-blue" type="button" name="cetak" value="Cetak SK" onclick="popup('<?php echo site_url(fmodule('reklame/sk/'.$ID_Izin)); ?>')"/>
													<?php } ?>
												</div>							
											</div>
											<?php } ?>
		...
		<script type="text/javascript">
			...
			$("#op_perusahaan").change(function(){
				$.ajax({
						type: "POST",
						url : "<?php echo site_url(fmodule('reklame/op_perusahaan')); ?>",
