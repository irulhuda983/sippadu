									...
									<?php echo form_open('',array('class' => 'form-horizontal', 'role' => 'form')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
											    ...
											    <div class="col-sm-6"><?php echo form_dropdown('op_level',$op_level,set_value('op_level',$d->ID_Level),'class="slc form-control" style="width:100%"'); ?></div>
											</div>

											<div class="form-group">
												<div class="col-sm-2">Group:</div>
											    <div class="col-sm-6"><?php echo form_dropdown('op_group',$op_group,set_value('op_group',$d->ID_Group),'class="slc form-control" style="width:100%"'); ?></div>
											</div> 	

											<div class="form-group">
												<div class="col-sm-2">Auth Mode:</div>
											    <div class="col-sm-6"><?php echo form_dropdown('op_auth_mode',$op_auth_mode,set_value('op_auth_mode',$d->Auth_Mode),'class="slc form-control" style="width:100%"'); ?></div>
											</div>
