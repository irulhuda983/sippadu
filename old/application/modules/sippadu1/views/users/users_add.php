									...
									<?php echo form_open('',array('class' => 'form-horizontal', 'role' => 'form')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
											   ...
											   <div class="col-sm-6"><input type="text" name="name" class="upper form-control" value="<?php echo set_value('name'); ?>"/></div>
											</div>  
											
											<div class="form-group">
												<div class="col-sm-2">Level:</div>
											   <div class="col-sm-6"><?php echo form_dropdown('op_level',$op_level,set_value('op_level'),'class="slc form-control" style="width:100%"'); ?></div>
											</div>

											<div class="form-group">
												<div class="col-sm-2">Group:</div>
											   <div class="col-sm-6"><?php echo form_dropdown('op_group',$op_group,set_value('op_group'),'class="slc form-control" style="width:100%"'); ?></div>
											</div> 	

											<div class="form-group">
												<div class="col-sm-2">Auth Mode:</div>
											   <div class="col-sm-6"><?php echo form_dropdown('op_auth_mode',$op_auth_mode,set_value('op_auth_mode'),'class="slc form-control" style="width:100%"'); ?></div>
											</div>								
