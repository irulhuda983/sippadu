    ...
    <body id="minovate" class="appWrapper">
                                ...
                                <div class="tile-body">
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Alamat atau Lokasi</label>
											...
											<div class="form-group" id="">
												<label for="" class="col-sm-2 control-label">Jenis Izin</label>
											   <div class="col-sm-6"><?php echo form_dropdown('op_kategori_imb',$op_kategori_imb,set_value('op_kategori_imb',$d2->Jenis_Bangunan),'id="op_kategori_imb" class="form-control slc"'); ?></div>
											</div> 
											
											<div class="form-group" id="">
												<label for="" class="col-sm-2 control-label">Peruntukan Bangunan</label>
											   <div class="col-sm-6"><?php echo form_dropdown('op_peruntukan_imb',$op_peruntukan_imb,set_value('op_peruntukan_imb',$d2->Peruntukan_Bangunan),'id="op_peruntukan_imb" class="form-control slc"'); ?></div>
											</div> 
											<div class="form-group">
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Nama Pemilik Sertifikat</label>
												<div class="col-sm-6"><input type="text" name="kepemilikan" id="kepemilikan" placeholder="Nama Pemilik Tanah" class="form-control" value="<?php echo set_value('kepemilikan',$d2->Nm_SHM); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">No. Sertifikat</label>
												<div class="col-sm-6"><input type="text" name="no_shm" id="no_shm" placeholder="No SHM" class="form-control" value="<?php echo set_value('no_shm',$d2->No_SHM); ?>" /></div>
											</div> 
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-2"><input type="button" class="btn btn-blue" value="Buat Nomor SK"  onclick="popup_el('<?php echo site_url(fmodule('imb/get_nomor/'.$ID_Izin)); ?>')"/></div>
											</div> 
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													...
													<input class="btn btn-blue" type="button" name="cetak" value="Cetak Tanda Terima" onclick="popup('<?php echo site_url(fmodule('imb/tt/'.$ID_Izin)); ?>')"/>
													<?php if($Kd_Access == 'bo') { ?>
													<input class="btn btn-blue" type="button" name="cetak" value="Cetak SK" onclick="popup('<?php echo site_url(fmodule('imb/sk/'.$ID_Izin)); ?>')"/>
													<?php } ?>
												</div>							
											</div>
											<?php } ?>
		...
		<script type="text/javascript">
			...
			$("#op_perusahaan").change(function(){
				$.ajax({
						type: "POST",
						url : "<?php echo site_url(fmodule('imb/op_perusahaan')); ?>",
