...
class Sippadu1 extends MX_Controller {
	...
	function __construct()
	{
		...
		$this->load->helper(array('url','apps','date','file','html'));
	...
	public function index()
	{
		...
		//$d['daftar_berita'] = $this->mod_simda->daftar_berita(6);
		$d['menuopen'] = 'dashboard';
		$d['menuactive'] = 'dashboard';
		$this->breadcrumb->append_crumb('Dashboard', '/');
		$this->load->view('dashboard',$d);
		//redirect('apps/keuangan/laporan/laporan/kas');
	...
	public function op_provinsi2(){
		if('IS_AJAX') {
			$d['op_provinsi2'] = $this->mod_sippadu->op_provinsi();
	...
	public function op_kota2(){
		if('IS_AJAX') {
			$d['op_kota2'] = $this->mod_sippadu->op_kota();
	...
	public function op_kecamatan2(){
		if('IS_AJAX') {
			$d['op_kecamatan2'] = $this->mod_sippadu->op_kecamatan();
	...
	public function op_desa2(){
		if('IS_AJAX') {
			$d['op_desa2'] = $this->mod_sippadu->op_desa();
