...
class Siup extends MX_Controller {
	...
	public function fo($offset=0)
	{
		...
		$config['base_url'] = site_url(fmodule('siup/fo'));
	...
	public function fo_all($offset=0)
	{
		...
		$config['base_url'] = site_url(fmodule('siup/fo_all'));
		$config['total_rows'] = $tot;
		$config['per_page'] = $limit;
		$config['uri_segment'] = 4;
		$config['first_link'] = 'First';
	...
	public function bo($offset=0)
	{
		...
		$config['base_url'] = site_url(fmodule('siup/bo'));
		$config['total_rows'] = $tot;
		$config['per_page'] = $limit;
		$config['uri_segment'] = 4;
		$config['first_link'] = 'First';
	...
	public function bo_all($offset=0)
	{
		...
		$config['base_url'] = site_url(fmodule('siup/bo_all'));
		$config['total_rows'] = $tot;
		$config['per_page'] = $limit;
		$config['uri_segment'] = 4;
		$config['first_link'] = 'First';
	...
	public function kabid($offset=0)
	{
		...
		$config['base_url'] = site_url(fmodule('siup/kabid'));
		$config['total_rows'] = $tot;
		$config['per_page'] = $limit;
		$config['uri_segment'] = 4;
		$config['first_link'] = 'First';
	...
	public function kabid_all($offset=0)
	{
		...
		$config['base_url'] = site_url(fmodule('siup/kabid_all'));
		$config['total_rows'] = $tot;
		$config['per_page'] = $limit;
		$config['uri_segment'] = 4;
		$config['first_link'] = 'First';
	...
	public function kadin($offset=0)
	{
		...
		$config['base_url'] = site_url(fmodule('siup/kadin'));
		$config['total_rows'] = $tot;
		$config['per_page'] = $limit;
		$config['uri_segment'] = 4;
		$config['first_link'] = 'First';
	...
	public function kadin_all($offset=0)
	{
		...
		$config['base_url'] = site_url(fmodule('siup/kadin_all'));
		$config['total_rows'] = $tot;
		$config['per_page'] = $limit;
		$config['uri_segment'] = 4;
		$config['first_link'] = 'First';
	...
	public function tu($offset=0)
	{
		...
		$config['base_url'] = site_url(fmodule('siup/tu'));
		$config['total_rows'] = $tot;
		$config['per_page'] = $limit;
		$config['uri_segment'] = 4;
		$config['first_link'] = 'First';
	...
	public function tu_all($offset=0)
	{
		...
		$config['base_url'] = site_url(fmodule('siup/tu_all'));
		$config['total_rows'] = $tot;
		$config['per_page'] = $limit;
		$config['uri_segment'] = 4;
		$config['first_link'] = 'First';
	...
	public function cetak($offset=0)
	{
		...
		$config['base_url'] = site_url(fmodule('siup/cetak'));
		$config['total_rows'] = $tot;
		$config['per_page'] = $limit;
		$config['uri_segment'] = 4;
		$config['first_link'] = 'First';
	...
	public function serah($offset=0)
	{
		...
		$config['base_url'] = site_url(fmodule('siup/serah'));
		$config['total_rows'] = $tot;
		$config['per_page'] = $limit;
		$config['uri_segment'] = 4;
		$config['first_link'] = 'First';
	...
	public function serah_all($offset=0)
	{
		...
		$config['base_url'] = site_url(fmodule('siup/serah_all'));
		$config['total_rows'] = $tot;
		$config['per_page'] = $limit;
		$config['uri_segment'] = 4;
		$config['first_link'] = 'First';
