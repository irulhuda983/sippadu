...
if($data->num_rows() > 0){ 
	...
	$daftar_ulang = $d->TDP_DAFTAR_ULANG;
}
...
<div class="form-group" id="">
   ...
   <div class="col-sm-6"><span id="dsp_provinsi"><?php echo form_dropdown('op_provinsi',op_provinsi(),set_value('op_provinsi',$provinsi),'id="op_provinsi" class="form-control slc"'); ?></span></div>
</div> 

<div class="form-group" id="">
	<label for="" class="col-sm-2 control-label">Kota</label>
   <div class="col-sm-6"><span id="dsp_kota"><?php echo form_dropdown('op_kota',op_kota($provinsi),set_value('op_kota',$kota),'id="op_kota" class="form-control slc"'); ?></span></div>
</div> 

<div class="form-group" id="">
	<label for="" class="col-sm-2 control-label">Kecamatan</label>
   <div class="col-sm-6"><span id="dsp_kecamatan"><?php echo form_dropdown('op_kecamatan',op_kecamatan($kota),set_value('op_kecamatan',$kecamatan),'id="op_kecamatan" class="form-control slc"'); ?></span></div>
</div> 

<div class="form-group" id="">
	<label for="" class="col-sm-2 control-label">Desa</label>
   <div class="col-sm-6"><span id="dsp_desa"><?php echo form_dropdown('op_desa',op_desa($kecamatan),set_value('op_desa',$desa),'id="op_desa" class="form-control slc"'); ?></span></div>
</div> 
<div class="form-group">
...
<span id="dsp_agenda" style="display:none;">
	<div class="form-group">
		...
		<div class="col-sm-4"><input type="text" name="no_agenda" id="no_agenda" placeholder="No Agenda" class="form-control" value="<?php echo html_entity_decode(set_value('no_agenda',$no_agenda)); ?>" readonly/></div>
		<div class="col-sm-2"><input type="button" class="btn btn-blue" value="Buat Nomor Agenda"  onclick="popup('<?php echo site_url(fmodule('tdp/get_agenda/'.$ID_Izin)); ?>')"/></div>
	</div> 
	<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-sm-6"><input type="text" name="no_sk_menteri" id="no_sk_menteri" placeholder="" class="form-control" value="<?php echo html_entity_decode(set_value('no_sk_menteri',$no_menteri)); ?>" /></div>
</div>  
<div class="form-group">
