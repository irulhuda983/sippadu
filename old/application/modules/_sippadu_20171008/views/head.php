		...
		<!--<script>window.jQuery2 || document.write('<script src="<?php echo base_url(); ?>themes/<?php echo config('theme'); ?>/js/jquery-1.8.2.min.js"><\/script>')</script>-->
		<script src="<?php echo base_url(); ?>themes/<?php echo config('theme'); ?>/js/jquery-1.8.2.min.js"></script>
		<!--<script>var jq182 = jq182.noConflict();</script>-->
		<style>
