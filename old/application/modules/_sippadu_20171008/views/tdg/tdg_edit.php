    ...
    <body id="minovate" class="appWrapper">
                                ...
                                <div class="tile-body">
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Lokasi Gudang</label>
												<div class="col-sm-6"><input type="text" name="lokasi" id="lokasi" placeholder="Lokasi Gudang" class="form-control" value="<?php echo set_value('lokasi',$d2->Lokasi); ?>" /></div>
											</div> 
											
											<div class="form-group" id="">
												<label for="" class="col-sm-2 control-label">Provinsi</label>
											   <div class="col-sm-6"><span id="dsp_provinsi2"><?php echo form_dropdown('op_provinsi2',op_provinsi(),set_value('op_provinsi2',ifnull($d2->Kd_Provinsi_Usaha,35)),'id="op_provinsi2" class="form-control slc"'); ?></span></div>
											</div> 

											<div class="form-group" id="">
												<label for="" class="col-sm-2 control-label">Kota</label>
											   <div class="col-sm-6"><span id="dsp_kota2"><?php echo form_dropdown('op_kota2',op_kota(ifnull($d2->Kd_Provinsi_Usaha,35)),set_value('op_kota2',ifnull($d2->Kd_Kota_Usaha,3522)),'id="op_kota2" class="form-control slc"'); ?></span></div>
											</div> 

											<div class="form-group" id="">
												<label for="" class="col-sm-2 control-label">Kecamatan</label>
											   <div class="col-sm-6"><span id="dsp_kecamatan2"><?php echo form_dropdown('op_kecamatan2',op_kecamatan(ifnull($d2->Kd_Kota_Usaha,3522)),set_value('op_kecamatan2',$d2->Kd_Kecamatan_Usaha),'id="op_kecamatan2" class="form-control slc"'); ?></span></div>
											</div> 

											<div class="form-group" id="">
												<label for="" class="col-sm-2 control-label">Desa</label>
											   <div class="col-sm-6"><span id="dsp_desa2"><?php echo form_dropdown('op_desa2',op_desa($d2->Kd_Kecamatan_Usaha),set_value('op_desa2',$d2->Kd_Desa_Usaha),'id="op_desa2" class="form-control slc"'); ?></span></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Telp/Fax/Email</label>
												<div class="col-sm-2"><input type="text" name="telp_usaha" id="telp_usaha" placeholder="Telpon Gudang" class="form-control" value="<?php echo set_value('telp_usaha',$d2->Telp_Usaha); ?>" /></div>
												<div class="col-sm-2"><input type="text" name="fax_usaha" id="fax_usaha" placeholder="Fax Gudang" class="form-control" value="<?php echo set_value('fax_usaha',$d2->Fax_Usaha); ?>" /></div>
												<div class="col-sm-2"><input type="text" name="email_usaha" id="email_usaha" placeholder="Email Gudang" class="form-control" value="<?php echo set_value('email_usaha',$d2->Email_Usaha); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Titik Koordinat</label>
												<div class="col-sm-6"><input type="text" name="koordinat" id="koordinat" placeholder="Koordinat Gudang" class="form-control" value="<?php echo set_value('koordinat',$d2->Koordinat); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Luas Gudang (M<sup>2</sup>)</label>
												<div class="col-sm-6"><input type="text" name="luas" id="luas" placeholder="Luas Gudang" class="form-control" value="<?php echo set_value('luas',$d2->Luas_Bangunan); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Kapasitas Gudang</label>
												<div class="col-sm-6"><input type="text" name="kapasitas" id="kapasitas" placeholder="Kapasitas Gudang" class="form-control" value="<?php echo set_value('kapasitas',$d2->Kapasitas); ?>" /></div>
											</div> 
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Golongan Gudang</label>
												<div class="col-sm-6"><input type="text" name="gol_usaha" id="gol_usaha" placeholder="Golongan Gudang" class="form-control" value="<?php echo set_value('gol_usaha',$d2->Golongan_Usaha); ?>" /></div>
											</div> 
											<!--<div class="form-group">
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Dasar Perttdgangan</label>
											...
											<div class="form-group">
												...
												<div class="col-sm-2"><input type="button" class="btn btn-blue" value="Buat Nomor SK"  onclick="popup_el('<?php echo site_url(fmodule('tdg/get_nomor/'.$ID_Izin)); ?>')"/></div>
											</div> 
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													...
													<input class="btn btn-blue" type="button" name="cetak" value="Cetak Tanda Terima" onclick="popup('<?php echo site_url(fmodule('tdg/tt/'.$ID_Izin)); ?>')"/>
													<?php if($Kd_Access == 'bo') { ?>
													<input class="btn btn-blue" type="button" name="cetak" value="Cetak SK" onclick="popup('<?php echo site_url(fmodule('tdg/sk/'.$ID_Izin)); ?>')"/>
													<?php } ?>
												</div>							
											</div>
											<?php } ?>
		...
		<script type="text/javascript">
			...
			$("#op_perusahaan").change(function(){
				$.ajax({
						type: "POST",
						url : "<?php echo site_url(fmodule('tdg/op_perusahaan')); ?>",
