								...
								<div class="tile-body">
									...
									<div class="block-fluid">  
										...
										<div class="form-group">
											<div class="col-sm-4"><?php echo form_dropdown('op_group',$op_group,set_value('op_group',$slc_op_group),'class="slc form-control" style="width:100%"'); ?></div>
									...
									<div class="block-fluid">
										...
										if($data_modul->num_rows() > 0){ 
											foreach($data_modul->result() as $dm){
												echo '<li>'.form_checkbox('modul[]',$dm->Kd_Modul,(group_modul_akses($slc_op_group,$dm->Kd_Modul) ? TRUE : FALSE)).' '.$dm->Nm_Modul.'</li>';
											}
										} 
										?>
										</ul>                 
