...
<body>	
	...
	<table width="1100" border="0" align="center" cellpadding="0" cellspacing="0" style="">
		...
		<tr>
			<td height="30" colspan="8" valign="top" class="style7">Telah diterima secara lengkap berkas permohonan <b><?php echo $Nm_Izin; ?> (<?php echo itkes($d->Kategori); ?>)&nbsp;</b>: </td>
		</tr>
		<tr>
		...
		<!--<tr>
			<td height="30">&nbsp;</td>
			<td valign="middle" class="style7">Jenis Izin</td>
			<td valign="middle" class="style7">:</td>
			<td colspan="5" valign="middle" class="style7"><?php echo itkes($d->Kategori); ?></td>
		</tr>-->
		<tr>
			<td height="30">&nbsp;</td>
		...
		<tr>
			...
			<?php echo strtoupper(ifnull($d->Alamat_Usaha,'-')); ?></td>
		</tr>
	</table>
	<br/><br/><br/>
	<table width="1100" border="0" align="center" cellpadding="0" cellspacing="0" style="">
