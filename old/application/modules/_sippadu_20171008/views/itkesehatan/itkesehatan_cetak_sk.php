...
<body class="page-border">
	...
	<table class="tb100 font12 tbpadding2 line2 bold" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;padding-left:0px;">
		<tr>
			<td colspan="3" ALIGN="left" class="bold">Yang bertanda tangan dibawah ini, Kepala <?php echo ucwords(strtolower(sippadu('nama_dinas'))); ?> <?php echo sippadu('nama_kota2'); ?>, memberikan Izin Kerja <?php echo itkes($d->Kategori,3); ?> kepada :</td>
		</tr>
		<!--<tr>
	...
	<table class="font12 tbttd2 fright tleft" border="0" align="center" cellpadding="0" cellspacing="0" style="color:black;padding-left:0px;">
		...
		<tr>
			<td align="left"  colspan="3"><br/><br/><br/><br/><br/><u><b><?php echo sippadu('nama_kadin'); ?></b></u><br/><?php echo sippadu('pangkat_kadin'); ?><br/>NIP. <?php echo sippadu('nip_kadin'); ?></td>
		</tr>
	</table>
