				...
				<div class="tile-body">
					...
					<?php echo form_open('',array('class' => 'form-horizontal', 'role' => 'form')); ?>			   
							...
							<div class="form-group">
								...
								<div class="col-sm-3"><?php echo form_dropdown('tanggal_lahir',op_tanggal(),set_value('tanggal_lahir',TimeFormat($d->TGL_LAHIR,'d')),'id="tanggal_lahir" class="form-control slc"'); ?></div>
								<div class="col-sm-3"><?php echo form_dropdown('bulan_lahir',op_bulan(),set_value('bulan_lahir',TimeFormat($d->TGL_LAHIR,'m')),'id="bulan_lahir" class="form-control slc"'); ?></div>
								<div class="col-sm-3"><?php echo form_dropdown('tahun_lahir',op_tahun(),set_value('tahun_lahir',TimeFormat($d->TGL_LAHIR,'Y')),'id="tahun_lahir" class="form-control slc"'); ?></div>
							</div>
