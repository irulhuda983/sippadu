...
<body>	
	...
	<table width="1100" border="0" align="center" cellpadding="0" cellspacing="0" style="">
		...
		<tr>
			...
			<td colspan="5" valign="middle" class="style7"><b><?php echo $d->IDSIUP; ?></b></td>
		</tr>
		<tr>
			<td height="30">&nbsp;</td>
			<td valign="middle" class="style7">Nama Pendaftar </td>
			<td valign="middle" class="style7">:</td>
			<td colspan="5" valign="middle" class="style7"><?php echo pelanggan($d->IDPELANGGAN,'nama'); ?></td>
		</tr>
		<tr>
			<td height="30">&nbsp;</td>
			<td valign="middle" class="style7">No. Identitas </td>
			<td valign="middle" class="style7">:</td>
			<td colspan="5" valign="middle" class="style7"><?php echo pelanggan($d->IDPELANGGAN,'kitas'); ?></td>
		</tr>
		<tr>
			<td height="30">&nbsp;</td>
			...
			<?php echo pelanggan($d->IDPELANGGAN,'alamat'); ?>
			<?php echo desa(pelanggan($d->IDPELANGGAN,'desa')); ?>, <?php echo kecamatan(pelanggan($d->IDPELANGGAN,'kecamatan')); ?>, <?php echo kota(pelanggan($d->IDPELANGGAN,'kota')); ?>, <?php echo provinsi(pelanggan($d->IDPELANGGAN,'provinsi')); ?>
			</td>
		</tr>
		<tr>
			<td height="30">&nbsp;</td>
		...
		<tr>
			...
			<td valign="middle" class="style7">:</td>
			<td colspan="5" valign="middle" class="style7"><?php echo perusahaan($d->IDPERUSAHAAN,'nama'); ?></td>
		</tr>
		<tr>
			<td height="30">&nbsp;</td>
			...
			<?php echo perusahaan($d->IDPERUSAHAAN,'alamat'); ?>
			<?php echo desa(perusahaan($d->IDPERUSAHAAN,'desa')); ?>, <?php echo kecamatan(perusahaan($d->IDPERUSAHAAN,'kecamatan')); ?>, <?php echo kota(perusahaan($d->IDPERUSAHAAN,'kota')); ?>, <?php echo provinsi(perusahaan($d->IDPERUSAHAAN,'provinsi')); ?>
		   </td>
		</tr>
	</table>
	<br/><br/><br/>
	...
	<table width="1100" border="0" align="center" cellpadding="0" cellspacing="0" style="">
		...
		<tr>
		   <td valign="middle" class="style7">&nbsp;</td>
		   <td height="30" colspan="" valign="middle" class="style8"><div align="center"><?php echo $d->IDAKSES; ?></div></td>
		</tr>
	</table>
