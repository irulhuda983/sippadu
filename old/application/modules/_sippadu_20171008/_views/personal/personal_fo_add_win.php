				...
				<div class="tile-body">
					...
					<?php echo form_open('',array('class' => 'form-horizontal', 'role' => 'form')); ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-3"><?php echo form_dropdown('tanggal_lahir',op_tanggal(),set_value('tanggal_lahir'),'id="tanggal_lahir" class="form-control slc"'); ?></div>
								<div class="col-sm-3"><?php echo form_dropdown('bulan_lahir',op_bulan(),set_value('bulan_lahir'),'id="bulan_lahir" class="form-control slc"'); ?></div>
								<div class="col-sm-3"><?php echo form_dropdown('tahun_lahir',op_tahun(),set_value('tahun_lahir'),'id="tahun_lahir" class="form-control slc"'); ?></div>
							</div>
							...
							<div class="form-group" id="">
							   ...
							   <div class="col-sm-10"><span id="dsp_provinsi"><?php echo form_dropdown('op_provinsi',op_provinsi(),set_value('op_provinsi',35),'id="op_provinsi" class="form-control slc"'); ?></span></div>
							</div> 
							
							<div class="form-group" id="">
								<label for="" class="col-sm-2 control-label">Kota</label>
							   <div class="col-sm-10"><span id="dsp_kota"><?php echo form_dropdown('op_kota',op_kota(35),set_value('op_kota',3522),'id="op_kota" class="form-control slc"'); ?></span></div>
							</div> 
							
							<div class="form-group" id="">
								<label for="" class="col-sm-2 control-label">Kecamatan</label>
							   <div class="col-sm-10"><span id="dsp_kecamatan"><?php echo form_dropdown('op_kecamatan',op_kecamatan(3522),set_value('op_kecamatan'),'id="op_kecamatan" class="form-control slc"'); ?></span></div>
							</div> 
							
							<div class="form-group" id="">
								<label for="" class="col-sm-2 control-label">Desa</label>
							   <div class="col-sm-10"><span id="dsp_desa"><?php echo form_dropdown('op_desa',$op_desa,set_value('op_desa'),'id="op_desa" class="form-control slc"'); ?></span></div>
							</div> 
