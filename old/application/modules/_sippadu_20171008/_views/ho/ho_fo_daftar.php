									...
									<?php echo form_open('',array('id'=>'form','class' => 'form-horizontal', 'role' => 'frm')); ?>
										<div class="block-fluid">                        
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="nama_l" id="nama_l" placeholder="Nama Pelanggan HO Sebelumnya" class="form-control" value="<?php echo set_value('nama_l'); ?>" /></div>
											</div> 
											...
											<div class="form-group">
												...
												<div class="col-sm-6"><input type="text" name="perihal" id="perihal" placeholder="Jenis Usaha" class="form-control" value="<?php echo set_value('perihal'); ?>" /></div>
											</div> 
											<!--<div class="form-group">
