                                ...
                                <div id="sidebarNav" class="panel-collapse collapse in" role="tabpanel">
                                    <div class="panel-body">
                                        <ul id="navigation">
											...
											<?php echo GroupMenuAkses(array(40,50,60,70,80,90,100,110,120,130,140),$DataAkses,'<li class="'.menuopen('fo',$menuopen).'">
												<a role="button" href="'.site_url(fmodule('personal')).'"><i class="fa fa-desktop"></i> <span>Front Office</span></a>
												<ul>
											...
											<?php echo GroupMenuAkses(array(51,61,71,81,91,101,111,121,131,141),$DataAkses,'<li class="'.menuopen('bo',$menuopen).'">
												<a role="button" href="'.site_url(fmodule('siup/bo')).'"><i class="fa fa-tasks"></i> <span>Back Office</span></a>
												<ul>
											...
											<?php echo GroupMenuAkses(array(52,62,72,82,92,102,112,122,132,142),$DataAkses,'<li class="'.menuopen('kabid',$menuopen).'">
												<a role="button" href="'.site_url(fmodule('siup/kabid')).'"><i class="fa fa-check-square-o"></i> <span>Kabid</span></a>
												<ul>
											...
											<?php echo GroupMenuAkses(array(53,63,73,83,93,103,113,123,133,143),$DataAkses,'<li class="'.menuopen('kadin',$menuopen).'">
												<a role="button" href="'.site_url(fmodule('siup/kadin')).'"><i class="fa fa-check"></i> <span>Kadin</span></a>
												<ul>
											...
											<?php echo GroupMenuAkses(array(54,64,74,84,94,104,114,124,134,144),$DataAkses,'<li class="'.menuopen('tu',$menuopen).'">
												<a role="button" href="'.site_url(fmodule('siup/tu')).'"><i class="fa fa-legal"></i> <span>Tata Usaha</span></a>
												<ul>
											...
											<?php echo GroupMenuAkses(array(55,65,75,85,95,105,115,125,135,144),$DataAkses,'<li class="'.menuopen('cetak',$menuopen).'">
												<a role="button" href="'.site_url(fmodule('siup/cetak')).'"><i class="fa fa-print"></i> <span>Cetak</span></a>
												<ul>
											...
											<?php echo GroupMenuAkses(array(56,66,76,86,96,106,116,126,136,146),$DataAkses,'<li class="'.menuopen('serah',$menuopen).'">
												<a role="button" href="'.site_url(fmodule('siup/serah')).'"><i class="fa fa-male"></i> <span>Pengambilan</span></a>
												<ul>
											...
											<?php echo GroupMenuAkses(array(5,57,67,77,87,97,107,117,127,137,147),$DataAkses,'<li class="'.menuopen('laporan',$menuopen).'">
												<a role="button" href="'.site_url(fmodule('laporan')).'"><i class="fa fa-file-o"></i> <span>Laporan</span></a>
												<ul>
													'.MenuAkses(5,$DataAkses,'<li class="'.menuactive('rekap_laporan',$menuactive).'"><a href="'.site_url(fmodule('laporan')).'"><i class="fa fa-circle-o"></i><span class="text">Rekap Laporan</span></a></li>').'
													'.MenuAkses(57,$DataAkses,'<li class="'.menuactive('siup_laporan',$menuactive).'"><a href="'.site_url(fmodule('siup/laporan')).'"><i class="fa fa-circle-o"></i><span class="text">SIUP</span></a></li>').'
