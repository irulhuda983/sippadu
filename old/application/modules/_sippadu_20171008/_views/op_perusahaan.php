...
<div class="form-group" id="">
   ...
   <div class="col-sm-6"><span id="dsp_provinsi"><?php echo form_dropdown('op_provinsi',op_provinsi(),set_value('op_provinsi',$d->PROVINSI),'id="op_provinsi" class="form-control slc"'); ?></span></div>
</div> 

<div class="form-group" id="">
	<label for="" class="col-sm-2 control-label">Kota</label>
   <div class="col-sm-6"><span id="dsp_kota"><?php echo form_dropdown('op_kota',op_kota($d->PROVINSI),set_value('op_kota',$d->KOTA),'id="op_kota" class="form-control slc"'); ?></span></div>
</div> 

<div class="form-group" id="">
	<label for="" class="col-sm-2 control-label">Kecamatan</label>
   <div class="col-sm-6"><span id="dsp_kecamatan"><?php echo form_dropdown('op_kecamatan',op_kecamatan($d->KOTA),set_value('op_kecamatan',$d->KECAMATAN),'id="op_kecamatan" class="form-control slc"'); ?></span></div>
</div> 

<div class="form-group" id="">
	<label for="" class="col-sm-2 control-label">Desa</label>
   <div class="col-sm-6"><span id="dsp_desa"><?php echo form_dropdown('op_desa',op_desa($d->KECAMATAN),set_value('op_desa',$d->DESA),'id="op_desa" class="form-control slc"'); ?></span></div>
</div> 
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-sm-6"><?php echo form_dropdown('op_bentuk_perusahaan',$op_bentuk_perusahaan,set_value('op_bentuk_perusahaan',$d->BNTK_PERUSAHAAN),'id="op_bentuk_perusahaan" class="form-control"'); ?></div>
</div>
<div class="form-group">
