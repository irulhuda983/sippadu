...
class Mod_tdi extends CI_Model {
	...
	function get_tbl_tdi_fo($status=0,$limit=0,$offset=0){
		...
		FROM
		tbtdi
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbtdi.ID_Pelanggan WHERE tbtdi.Flow_FO = 1 and tbtdi.Flow_BO = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_tdi_kabid($status=0,$limit=0,$offset=0){
		...
		FROM
		tbtdi
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbtdi.ID_Pelanggan WHERE tbtdi.Flow_FO = 1 and tbtdi.Flow_BO = 1 and tbtdi.Flow_Kabid = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_tdi_kadin($status=0,$limit=0,$offset=0){
		...
		FROM
		tbtdi
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbtdi.ID_Pelanggan WHERE tbtdi.Flow_FO = 1 and tbtdi.Flow_BO = 1 and tbtdi.Flow_Kabid = 1 and tbtdi.Flow_Kadin = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_tdi_tu($status=0,$limit=0,$offset=0){
		...
		FROM
		tbtdi
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbtdi.ID_Pelanggan WHERE tbtdi.Flow_FO = 1 and tbtdi.Flow_BO = 1 and tbtdi.Flow_Kabid = 1 and tbtdi.Flow_Kadin = 1 and tbtdi.Flow_TU = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_tdi_cetak($status=0,$limit=0,$offset=0){
		...
		FROM
		tbtdi
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbtdi.ID_Pelanggan WHERE tbtdi.Flow_FO = 1 and tbtdi.Flow_BO = 1 and tbtdi.Flow_Kabid = 1 and tbtdi.Flow_Kadin = 1 and tbtdi.Flow_TU = 1 and tbtdi.Flow_Serah = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
