...
class Mod_reklame extends CI_Model {
	...
	function get_tbl_reklame_fo($status=0,$limit=0,$offset=0){
		...
		FROM
		tbreklame
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbreklame.ID_Pelanggan WHERE tbreklame.Flow_FO = 1 and tbreklame.Flow_BO = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_reklame_kabid($status=0,$limit=0,$offset=0){
		...
		FROM
		tbreklame
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbreklame.ID_Pelanggan WHERE tbreklame.Flow_FO = 1 and tbreklame.Flow_BO = 1 and tbreklame.Flow_Kabid = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_reklame_kadin($status=0,$limit=0,$offset=0){
		...
		FROM
		tbreklame
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbreklame.ID_Pelanggan WHERE tbreklame.Flow_FO = 1 and tbreklame.Flow_BO = 1 and tbreklame.Flow_Kabid = 1 and tbreklame.Flow_Kadin = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_reklame_tu($status=0,$limit=0,$offset=0){
		...
		FROM
		tbreklame
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbreklame.ID_Pelanggan WHERE tbreklame.Flow_FO = 1 and tbreklame.Flow_BO = 1 and tbreklame.Flow_Kabid = 1 and tbreklame.Flow_Kadin = 1 and tbreklame.Flow_TU = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_reklame_cetak($status=0,$limit=0,$offset=0){
		...
		FROM
		tbreklame
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbreklame.ID_Pelanggan WHERE tbreklame.Flow_FO = 1 and tbreklame.Flow_BO = 1 and tbreklame.Flow_Kabid = 1 and tbreklame.Flow_Kadin = 1 and tbreklame.Flow_TU = 1 and tbreklame.Flow_Serah = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
