...
class Mod_imb extends CI_Model {
	...
	function get_tbl_imb_fo($status=0,$limit=0,$offset=0){
		...
		FROM
		tbimb
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbimb.ID_Pelanggan WHERE tbimb.Flow_FO = 1 and tbimb.Flow_BO = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_imb_kabid($status=0,$limit=0,$offset=0){
		...
		FROM
		tbimb
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbimb.ID_Pelanggan WHERE tbimb.Flow_FO = 1 and tbimb.Flow_BO = 1 and tbimb.Flow_Kabid = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_imb_kadin($status=0,$limit=0,$offset=0){
		...
		FROM
		tbimb
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbimb.ID_Pelanggan WHERE tbimb.Flow_FO = 1 and tbimb.Flow_BO = 1 and tbimb.Flow_Kabid = 1 and tbimb.Flow_Kadin = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_imb_tu($status=0,$limit=0,$offset=0){
		...
		FROM
		tbimb
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbimb.ID_Pelanggan WHERE tbimb.Flow_FO = 1 and tbimb.Flow_BO = 1 and tbimb.Flow_Kabid = 1 and tbimb.Flow_Kadin = 1 and tbimb.Flow_TU = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_imb_cetak($status=0,$limit=0,$offset=0){
		...
		FROM
		tbimb
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbimb.ID_Pelanggan WHERE tbimb.Flow_FO = 1 and tbimb.Flow_BO = 1 and tbimb.Flow_Kabid = 1 and tbimb.Flow_Kadin = 1 and tbimb.Flow_TU = 1 and tbimb.Flow_Serah = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
