...
class Mod_tdup extends CI_Model {
	...
	function get_tbl_tdup_fo($status=0,$limit=0,$offset=0){
		...
		FROM
		tbtdup
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbtdup.ID_Pelanggan WHERE tbtdup.Flow_FO = 1 and tbtdup.Flow_BO = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_tdup_kabid($status=0,$limit=0,$offset=0){
		...
		FROM
		tbtdup
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbtdup.ID_Pelanggan WHERE tbtdup.Flow_FO = 1 and tbtdup.Flow_BO = 1 and tbtdup.Flow_Kabid = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_tdup_kadin($status=0,$limit=0,$offset=0){
		...
		FROM
		tbtdup
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbtdup.ID_Pelanggan WHERE tbtdup.Flow_FO = 1 and tbtdup.Flow_BO = 1 and tbtdup.Flow_Kabid = 1 and tbtdup.Flow_Kadin = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_tdup_tu($status=0,$limit=0,$offset=0){
		...
		FROM
		tbtdup
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbtdup.ID_Pelanggan WHERE tbtdup.Flow_FO = 1 and tbtdup.Flow_BO = 1 and tbtdup.Flow_Kabid = 1 and tbtdup.Flow_Kadin = 1 and tbtdup.Flow_TU = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
	...
	function get_tbl_tdup_cetak($status=0,$limit=0,$offset=0){
		...
		FROM
		tbtdup
		INNER JOIN tbpelanggan ON tbpelanggan.IDPELANGGAN = tbtdup.ID_Pelanggan WHERE tbtdup.Flow_FO = 1 and tbtdup.Flow_BO = 1 and tbtdup.Flow_Kabid = 1 and tbtdup.Flow_Kadin = 1 and tbtdup.Flow_TU = 1 and tbtdup.Flow_Serah = "'.$status.'" '.$q_where.' '.$q_order.' '.$q_limit.'');
		return $a;
	}
