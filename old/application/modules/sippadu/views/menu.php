                                        ...
                                        <ul id="navigation">
											...
											<?php echo GroupMenuAkses(array(30),$DataAkses,'<li class="'.menuopen('master',$menuopen).'">
												...
												<ul>
													...
													'.MenuAkses(34,$DataAkses,'<li class="'.menuopen('master_region',$menuactive).'"><a href="'.site_url(fmodule('master/provinsi')).'"><i class="fa fa-circle-o"></i><span class="text">Wilayah/Sub Wilayah</span></a>
													</li>').'
												</ul>
											</li>'); ?>
