										...
										<div class="row">
											...
											<div class="col-sm-8">
												<div class="btn-group mb-10">
													<input class="btn btn-blue" type="button" name="add" value="Tambah Data Pemohon" onclick="popup('<?php echo site_url(fmodule('personal/fo_add_win/'.encrypt(site_url(fmodule('tdi/fo_daftar'))))); ?>')"/>
												</div>
											</div>
														...
														if($data->num_rows() > 0){
															foreach($data->result() as $d){
																...
																<tr style="font-weight: bold;">          
																	...
																	<td>'.$d->NOKITAS.'</td> 
																	<td align="center">'.anchor_label(site_url(fmodule('tdi/fo_daftar/1/'.$d->IDPELANGGAN)),'Daftar Baru','info').'</td>	
																</tr>  ';
																echo cari_history_tdi($d->IDPELANGGAN);
															}
														}
													?>
												</tbody>
