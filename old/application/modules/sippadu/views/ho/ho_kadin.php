									...
									<div class="tile-widget">
										...
										<div class="row">
											...
											<div class="col-sm-8">
												...
												<input class="btn btn-greensea" type="button" name="add" value="Izin Belum Diproses" onclick="window.location.href='<?php echo site_url(fmodule('ho/kadin')); ?>'"/>
												<input class="btn btn-dutch" type="button" name="add" value="Izin Telah Diproses" onclick="window.location.href='<?php echo site_url(fmodule('ho/kadin_all')); ?>'"/>
											</div>
